...
![](/img/blog/optimizing-tinacms-with-nextjs-and-vercel-data-cache/use-cache-nextjs.png "If you're using Next.js 15, you can opt into caching for better performance - https://nextjs.org/docs/app/api-reference/directives/use-cache")
