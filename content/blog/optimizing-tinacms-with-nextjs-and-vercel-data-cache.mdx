...
next: ''
---
**Updated 31/3/2025:** Added a couple images to add additional information on enabling the Vercel Data Cache and possible issues.

**Updated 19/3/2025:** Added a video to demo how the Vercel Data Cache could affect your site and how to tweak Next.js so that you can better use the cache.
...
![](/img/blog/optimizing-tinacms-with-nextjs-and-vercel-data-cache/one-year-caching.png "One of our sites using TinaCMS experienced late content updates due to 1 year default caching")
