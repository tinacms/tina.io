---
seo:
  title: A/B Testing with Next.js Middleware | TinaCMS Blog
  description: >-
    Discover how to set up A/B tests in TinaCMS, enabling data-driven decisions
    by comparing content variations to optimize user engagement & performance
title: A/B testing with Next.js Middleware and TinaCMS
date: '2022-05-30T14:00:00.000Z'
author: James Perkins & James O'Halloran
prev: content/blog/basics-of-graphql.mdx
next: content/blog/tina-next-i18n.mdx
---
