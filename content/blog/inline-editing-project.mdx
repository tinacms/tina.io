...
We chose to specifically focus on [Inline Blocks](/docs/editing/blocks), to hone in on the page builder capacities of Tina. What follows are some **improvements and changes** made within react-tinacms-inline, along with process notes gathered throughout the course of this project:
