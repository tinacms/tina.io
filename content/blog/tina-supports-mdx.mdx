---
seo:
  title: TinaCMS Supports MDX | TinaCMS Blog
  description: >-
    TinaCMS now supports MDX, enabling the integration of React components
    within Markdown for more dynamic and customizable content management.
title: TinaCMS now supports MDX.
date: '2021-10-26T08:00:00-04:00'
last_edited: '2021-10-26T08:00:00-04:00'
author: James Perkins
prev: content/blog/our-friend-frank-taillandier.mdx
next: content/blog/mdx-powered-docs.mdx
---

The team at TinaCMS is dedicated to revolutionizing the CMS space. We were the first to offer visual editing in real-time which enabled teams to be more productive. Now we are introducing the world’s first UI editor for MDX. This empowers content teams to add components to a page with a single click.
...
Check out the steps to start using MDX :

### Update to the latest version TinaCMS
...
1. Add the fields for your components to your `schema.ts`
...
1. Add the components to your TinaCMS powered pages.
