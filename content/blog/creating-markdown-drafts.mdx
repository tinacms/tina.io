...
seo:
  title: Creating Markdown Drafts | TinaCMS Blog
  description: >-
    Learn how to create and manage Markdown drafts in TinaCMS, enabling easy
    editing and previewing of content before publishing to your site.
title: Creating Markdown Drafts with Gatsby
date: '2019-10-28T22:17:53.124Z'
author: Nolan Phillips & Kendall Strautman
prev: content/blog/announcing-tinacms.mdx
next: content/blog/simple-markdown-blog-nextjs.mdx
---
...
TinaCMS will only add the draft frontmatter value to files after it's been edited. If the draft frontmatter value is not set on a file, it will be `null` (falsy)and will get published in all environments.
