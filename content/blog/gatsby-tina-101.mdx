...
next: content/blog/introducing-visual-open-authoring.mdx
---
...
*Tyra* uses Markdown for content, but TinaCMS also supports JSON files via [gatsby-tinacms-json](/docs/guides/converting-gatsby-to-tina). I find that JSON is great for page content and [blocks](https://tinacms.org/blog/what-are-blocks/). But for simple blog posts, Markdown works great.
