---
seo:
  title: TinaCMS Config Rearrangements | TinaCMS Blog
  description: >-
    Important rearrangements to the TinaCMS config, improving customization and
    streamlining the setup process for a better developer experience.
title: TinaCMS Config Rearrangements
date: '2023-03-27T07:00:00.000Z'
last_edited: '2023-03-27T07:00:00.000Z'
author: Jeff See
prev: content/blog/tinacms-1.4.mdx
next: content/blog/TinaCMS-Version-1-5.mdx
---

TinaCMS's latest release adds support for a new config folder at `<root>/tina`.

## TL;DR

* The TinaCMS config is now at `tina/config.{ts,tsx,js,jsx}`. `.tina` configs will continue to work.
