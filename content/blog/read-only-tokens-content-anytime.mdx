---
seo:
  title: 'Read-Only Tokens: Access Content Anytime | TinaCMS Blog'
  description: >-
    Learn how to use read-only tokens in TinaCMS to securely access and display
    content anytime, even without full editing permissions.
title: Read-only tokens - Query Requests anytime
date: '2022-04-05T07:00:00.000Z'
author: James Perkins
prev: content/blog/data-layer-performant-editing.mdx
...
Navigate to [TinaCloud](https://app.tina.io) and click on the project you wish to add a token to, click on the "tokens" tab

![TinaCloud token tab](/img/graphql-docs/token-tab.png)
...
![Creating a new token in TinaCloud](/img/graphql-docs/create-new-token.png)

Finally, click "Create Token".

![Successful creation of a token in TinaCloud](/img/graphql-docs/final-token-page.png)
