...
Tina is not a CMS, in the traditional sense. As in, it’s not a *separate* system for managing content. Instead, Tina adds editing functionality to your site when running in dev mode locally, or when using [TinaCloud](/docs/tinacloud/overview) (cloud)...In fact, I'm writing this post with Tina right now:
