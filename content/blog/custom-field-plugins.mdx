...
> If you’re working with Gatsby, this [looks slightly different](/guides/gatsby/custom-email-field/register-field). *Hint*: you’ll head to the **gatsby-browser.js** file to access the CMS instance.
