...
seo:
  ...
  description: Explore how to create and use custom field plugins in TinaCMS to extend functionality and tailor the editing experience to your project’s needs.
