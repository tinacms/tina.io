...
One of the most common questions we hear is how TinaCMS works so seamlessly with GitHub. The answer lies in the data layer, a core part of how TinaCMS handles content efficiently behind the scenes.
...
Instead of sending repeated requests directly to GitHub every time content is queried or updated, TinaCMS routes those interactions through the data layer. This creates a more efficient and responsive experience when working with content.
...
You can configure the data layer yourself using TinaCMS’s self-hosting packages. This gives you full control, but it also requires additional setup and maintenance.
