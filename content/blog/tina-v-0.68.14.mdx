---
seo:
  title: TinaCMS v0.68.14 | TinaCMS Blog
  description: >-
    TinaCMS v0.68.14 fixes issues with content previews and improves performance
    for faster page loads, providing a more responsive experience for users.
title: TinaCMS V0.68.14
date: '2022-07-21T04:00:00.000Z'
last_edited: '2022-07-21T04:00:00.000Z'
author: Logan Anderson
prev: content/blog/tina-next-i18n.mdx
next: content/blog/tina-v-0.69.7.mdx
---

TinaCMS Version `0.68.14` brings some extensive improvements to TinaCMS. Here is a short list of a few of the major features:
...
The token must be a wildcard token (`*`) and can be generated from the TinaCMS dashboard. Read more about read only tokens [here](https://tina.io/blog/read-only-tokens-content-anytime)

For more information about where to get these values, see the ["going to production"](/docs/tinacloud/overview/#enabling-tina-cloud-in-tinacms) docs.
