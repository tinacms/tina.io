...
seo:
  title: Exporting WordPress Content to Gatsby | TinaCMS Blog
  description: >-
    Learn how to export your WordPress content to Gatsby with TinaCMS,
    streamlining the process of migrating to a faster, more flexible static site
    setup.
title: Export WordPress Content to Markdown and Gatsby
date: '2020-01-13T00:00:00.000Z'
author: Mitch MacKenzie
prev: content/blog/three-ways-to-edit-md.mdx
next: content/blog/custom-field-components.mdx
---
...
And don't forget to consult the [docs](/docs/guides/converting-gatsby-to-tina) to learn more about how TinaCMS can work with Gatsby.
