...
One of the more recent additions has been the [`ScreenPlugin`](/docs/editing/blocks), which is the topic of this blog. Screens allow you to render modal UI and handle various content editing needs. For example, one might use a *Screen Plugin* to register a form to edit 'global site data'.
