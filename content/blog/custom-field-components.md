...
In this step, we need to create the custom field definition and pass in the `RangeInput` component inline. We'll go back to our _About Me_ page [form options](/guides/gatsby/gatsby-json/customize-form):
