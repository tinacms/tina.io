---
seo:
  title: TinaCMS 1.0 Announcement | TinaCMS Blog
  description: >-
    TinaCMS officially launches version 1.0! This is a major milestone with new
    features and improvements - try the TinaCMS starter now!
title: TinaCMS v1.0 is live!
date: '2022-11-08T04:00:00.000Z'
last_edited: '2022-11-07T04:00:00.000Z'
author: James O'Halloran
prev: content/blog/upgrading-to-iframe.mdx
next: content/blog/TinaCMS-New-Public-Roadmap.mdx
---
...
> For existing TinaCMS sites looking to migrate to the latest iframe-based changes, [see our migration doc here](https://tina.io/blog/upgrading-to-iframe/)

## New pricing in effect

TinaCloud's new pricing will go into effect now that TinaCMS is out of Beta. For organizations that were created during the beta phase, pricing will go into effect on December 1st.
![TinaCMS Launch Pricing](/img/blog/tina-1-0-announcement/TinaCMS_pricing_1.png)

> Please see the [pricing page](https://tina.io/pricing/ "pricing") for up to date TinaCloud rates

## A Fresh coat of paint

TinaCMS's landing page also got a fresh new look along with this release.

![TinaCMS Launch Pricing](/img/blog/tina-1-0-announcement/tinaio-homepage.png)
