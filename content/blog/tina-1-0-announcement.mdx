---
seo:
  title: Tina 1.0 Announcement | TinaCMS Blog
  description: >-
    TinaCMS officially launches version 1.0! This is a major milestone with new
    features and improvements - try the Tina starter now!
...
TinaCloud's new pricing will go into effect now that Tina is out of Beta. For organizations that were created during the beta phase, pricing will go into effect on December 1st.
![Tina Launch Pricing](/img/blog/tina-1-0-announcement/TinaCMS_pricing_1.png)
...
![Tina Launch Pricing](/img/blog/tina-1-0-announcement/tinaio-homepage.png)
