---
seo:
  title: TinaCMS 1.1.3 | TinaCMS Blog
  description: >-
    TinaCMS 1.1.3 introduces bug fixes and performance enhancements, improving
    stability and streamlining the content management process for developers.
...
next: content/blog/self-hosted-datalayer.mdx
---
...
![shortcode ui](/img/blog/tina-v-1.1.3/shortcodes.png)

See the [custom shortcode syntax documentation](https://tina.io/docs/reference/types/rich-text/#custom-shortcode-syntax) for more info.
...
![min max](/img/blog/tina-v-1.1.3/minmax.png)
