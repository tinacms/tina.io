---
seo:
  title: Data Layer for Performant Editing | TinaCMS Blog
  description: >-
...
* Changes to the path to [.tina](/docs/troubleshooting/git-repository-issues/#monorepo-support)
* Changes to the configured [repository](https://tina.io/docs/tinacloud/dashboard/projects/#changing-the-repository)
