...
Today we're excited to announce the first iteration of TinaCMS's self-hosted Data Layer. See the [in-depth walkthrough and demo on GitHub](https://github.com/tinacms/tinacms/discussions/3589).
