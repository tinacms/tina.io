---
seo:
  title: Self-Hosted Data Layer | TinaCMS Blog
  description: >-
    Learn how to set up a self-hosted Data Layer with TinaCMS, giving you full
    control over your data while improving scalability and performance.
title: Self-Hosting the TinaCMS Data Layer
date: '2023-01-31T04:00:00.000Z'
last_edited: '2026-02-10T23:24:00.000Z'
author: Scott Gallant & James O'Halloran
prev: content/blog/tina-v-1.1.3.mdx
next: content/blog/tina-v-1.1.4.mdx
---

**Updated 11/02/2026:** Updated the blog post with the latest TinaCMS Data Layer diagram.
...
By self-hosting the TinaCMS Data Layer, you can run TinaCMS without lock-in to TinaCloud.
...
When you’re developing your site locally, the Data Layer doesn’t need to be configured and just runs in the background. If you use TinaCloud in production, it runs your TinaCMS Data Layer for you and syncs with GitHub. Now, you can host your own Data Layer as an alternative to using TinaCloud.

## When does indexing happen in the Data Layer?

If your site uses TinaCloud in production, the Data Layer is indexed every time there is a change to the associated GitHub repository using webhooks. When self-hosting, indexing occurs only when your site is built. Any content updates made by editors using TinaCMS will be immediately reflected in the Data Layer, but any edits made directly to the GitHub repository outside of TinaCMS won't be visible until the site is rebuilt.

## Is the TinaCMS Data Layer open-source?
