...
seo:
  ...
  description: >-
    Version 1.1.4 brings key updates, including performance improvements and bug
    fixes, enhancing the overall TinaCMS content management experience.
title: TinaCMS V1.1.4
date: '2023-01-31T04:00:00.000Z'
last_edited: '2023-01-31T04:00:00.000Z'
author: James O'Halloran
prev: content/blog/self-hosted-datalayer.mdx
next: content/blog/2023-02-security-update.mdx
---
...
TinaCMS now supports sourcing content from a separate Git repo. With this approach you can continue to define your TinaCMS config in your "website repo", but documents will be saved elsewhere.

## Renaming Documents

Editors can now rename documents from the document list view

![Renaming Document](/img/blog/tina-v-1.1.4/edit-doc.png "Renaming Document")
...
![rich-text-error](/img/blog/tina-v-1.1.4/edit-rtf.png "rich-text-error")
