...
draft: false
seo:
  title: Simple Markdown Blog with Next.js | TinaCMS Blog
  description: >-
    Learn how to create a simple markdown blog with Next.js and TinaCMS,
    combining flexibility and ease of use for streamlined content management.
...
next: content/blog/tina-v-1.1.3.mdx
---
...
*Want to skip to using TinaCMS with Next.js? [checkout our quickstart](https://tina.io/docs/setup-overview/ "TinaCMS Quickstart")*
...
![The starter project in action](/img/blog/simple-markdown-blog-nextjs/empty-tina-blog.png "The starter project in action")
...
Also, **place the images referenced in the `.md` files in the public directory**. In Next.js, you can access any file inside public from the base URL `/`.
...
> Before the release of Next.js 9.3, this path generation for static export could be handled via the exportPathMap.
...
You know that you want to be part of this creative, innovative, supportive community of developers (and even some editors and designers) who are experimenting and implementing TinaCMS daily.

Check out TinaCMS's community at [https://tina.io/community/](https://tina.io/community/)

For more information about serving static files in Next.js, check out the [static file serving documentation](https://nextjs.org/docs/app/building-your-application/optimizing/static-assets).

For more information about static exports in Next.js, check out the [static exports documentation](https://nextjs.org/docs/app/building-your-application/deploying/static-exports).
```
