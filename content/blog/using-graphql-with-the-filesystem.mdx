...
> 💡Tip: if you have a GraphQL client like [Altair](https://altairgraphql.dev/) you can explore the API by pointing it to [http://localhost:4001/graphql](http://localhost:4001/graphql)
