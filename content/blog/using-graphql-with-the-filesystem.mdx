...
author: Jeff See
prev: content/blog/tina-cloud-a-headless-cms-backed-by-git.mdx
...
> 💡Tip: if you have a GraphQL client like [Altair](https://altair.sirmuel.design/) you can explore the API by pointing it to [http://localhost:4001/graphql](http://localhost:4001/graphql)
...
Being able to work locally with GraphQL is a first step to help us bring the capabilities of a full-fledged CMS to the filesystem. TinaCloud will offer the same great experience through a hosted headless API. In the coming weeks we'll continue sharing more about how this API works with TinaCMS to bring visual content management to your website with minimal overhead.
