...
seo:
  title: Dynamic Plugin System | TinaCMS Blog
  description: >-
    TinaCMS’s dynamic plugin system allows you to extend functionality and
    customize your content management experience with flexible, reusable
    plugins.
...
Interested in creating your own plugin? Head over to the contribution [guidelines](https://tinacms.org/docs/contributing/guidelines). Feel free to post any questions or comments in the [TinaCMS Discord](https://discord.com/invite/zumN63Ybpf).
