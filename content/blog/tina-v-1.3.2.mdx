...
seo:
  ...
  description: >-
    TinaCMS 1.3.2 introduces improved API performance, enhanced error handling,
    and better support for custom fields.
title: TinaCMS V1.3.2
date: '2023-03-10T04:00:00.000Z'
last_edited: '2023-03-10T04:00:00.000Z'
author: James O'Halloran
prev: content/blog/tinasaurus-docusaurus-starter.mdx
next: content/blog/tinacms-1.4.mdx
---
...
TinaCMS now supports fields with special characters through the use of the `nameOverride` property.
...
![Media Grid View](/img/blog/tina-v-1.3.2/media-manager_uuaotf.png "Media Grid View")
...
* fix: "Previous Directory" link in TinaCMS MediaManager (Thanks @coreyaus)!
