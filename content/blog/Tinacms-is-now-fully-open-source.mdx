...
> The following may no longer be accurate, see the[ official roadmap](https://tina.io/roadmap/ "Roadmap") and [GitHub](https://github.com/tinacms) pages for up to date development info
