...
seo:
  title: More Changes Coming to Inline Editing | TinaCMS Blog
  description: >-
    Learn about the upcoming changes to inline editing in TinaCMS, including new
    features and improvements aimed at making content updates even easier.
title: More Changes Coming to Inline Editing
date: '2021-01-13T10:16:45-05:00'
last_edited: '2021-01-13T15:45:05.411Z'
author: DJ
prev: content/blog/introducing-media-manager.mdx
next: content/blog/2021-q1-tinacms-updates.mdx
---

It was around six months ago that we last dug deep into TinaCMS's inline editing experience. At that time, we introduced new features and improved the UI of inline editing. Since then, there have been a few pain points we've run into from time to time.
...
TinaCMS currently has two possible interfaces for editing content: *sidebar-based*, and *inline*.
...
Check out the [GitHub project for this cycle](https://github.com/tinacms/tinacms) to keep tabs on our work.
