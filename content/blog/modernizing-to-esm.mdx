...
With this update, we’ve upgraded Mermaid to the latest version, ensuring that your diagrams within the editor are faster, more stable, and feature-rich.
...
1. **Check your imports:** Ensure you are using `import` instead of `require` in your TinaCMS configuration files.
