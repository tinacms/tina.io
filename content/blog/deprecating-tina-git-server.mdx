...
We've changed our recommended approach for using Tina's Git Backend with Next.js websites. Check out [Tina's Next.js documentation](/docs/reference/self-hosted/tina-backend/nextjs) for details.
