...
author: Matt Wicks
prev: content/blog/two-factor-authentication.mdx
next: ''
---

## Overview of the Incident

On 15th December 2024, TinaCMS identified unauthorized activity involving compromised AWS access keys. These keys were exploited to send unauthorized emails (targeting the general French community, not TinaCMS customers specifically) using our Amazon Simple Email Service (SES) infrastructure.
...
9. ✅ Done - IP allow listing for AWS access:
...
10. ✅ Done - Continuous monitoring and alerts:
