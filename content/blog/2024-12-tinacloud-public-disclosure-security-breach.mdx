...
![A screenshot of one of the phishing emails](/img/blog/2024-12-tinacloud-public-disclosure-security-breach/phishing-email.png "Figure: the emails sent were in French")\
**Figure: the emails sent were in French**

As an automated measure, the impacted key was revoked. Afterwards, our rapid response team confirmed the extent of the incident using CloudTrail logs, investigated root cause, and took steps (described below) to secure our systems.
...
Time of Detection: 15th December 2024, 07:05 UTC
