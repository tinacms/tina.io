...
prev: content/blog/2023-02-security-update.mdx
next: content/blog/tina-v-1.3.2.mdx
---
...
Tinasaurus is based off of the default, classic Docusaurus theme with some modifications to make the editing experience great.
