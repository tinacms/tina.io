...
seo:
  ...
  description: 'Discover Visual Open Authoring in TinaCMS, which enables content creators to edit directly on the site with a user-friendly, visual interface.'
