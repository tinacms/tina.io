---
seo:
  title: Click-to-Edit Comes to Visual Editing | TinaCMS Blog
  description: >-
    TinaCMS introduces Click-to-Edit for Visual Editing, now you can make real-time
    content changes directly on the page for a seamless editing experience.
title: Click-to-Edit Comes to Visual Editing
date: '2023-05-17T03:00:00.000Z'
author: Scott Gallant
prev: content/blog/TinaCMS-Version-1-5.mdx
next: content/blog/TinaCMS-Version-1-5-9.mdx
---

I’m excited to share that TinaCMS’s visual editing UX just got a lot better with click-to-edit functionality.

This pops open the TinaCMS sidebar at the right location when you click editable elements on the page.  See it in action on [roev.com](https://www.roev.com/) here:
...
We've been using this internally for a while now and it's one of those features that makes you think "how did we do it before?". Going back to the old way where you have to traverse nested forms in TinaCMS's sidebar to find the right field feels very cumbersome.
