---
seo:
  title: Manage Your Media with Cloudinary | TinaCMS Blog
  description: >-
    Learn how to integrate Cloudinary with TinaCMS to efficiently manage and
    optimize your media files, improving image delivery and storage.
title: Manage your media with Cloudinary
date: '2021-07-09T08:34:47-04:00'
last_edited: '2021-07-09T13:35:07.608Z'
author: James Perkins
prev: content/blog/structure-your-content-with-graphql-in-tina.mdx
next: content/blog/tina-is-in-beta.mdx
---

# TinaCMS now supports Cloudinary as a Media Manager

We released our public alpha just over a month ago and one thing that has come up in the feedback we have been collecting is the ability to use TinaCMS's Media Manager. This was a core feature that gives content creators the ability to drag and drop their images or replace an image easily. We decided to start with Cloudinary, to allow users to keep their GitHub repositories lightweight.
...
All image formats that are supported by Cloudinary are supported by TinaCMS which are the following:
...
Now that you have installed the TinaCMS Cloudinary package, we need to make some changes to our TinaCMS application to add support for images. Firstly you will need to update your TinaCMS client to include the Cloudinary package:
...
Note that developers can [pass a `pageSize` option to the media store](https://github.com/tinacms/tina-graphql-gateway/blob/main/packages/next-tinacms-cloudinary/README.md) in order to decide how many media should be displayed per page in the manager. We'll continue improving Cloudinary integration and look into media caching later, for now, we feel it's already a huge step to make sure your content team can manage media like a pro in TinaCMS.
