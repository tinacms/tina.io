---
seo:
  title: 'Upgrade Notice: Improved GitHub Security | TinaCMS Blog'
  description: >-
    TinaCMS now includes enhanced GitHub security features. Learn about the
    improvements and how they protect your content and data within TinaCMS.
title: 'Upgrade Notice: Improved GitHub Security'
date: '2020-06-23T13:47:03-03:00'
last_edited: 'July 30, 2020'
author: Joel Huggett
prev: content/blog/software-engineering-daily-podcast-tinacms.mdx
next: content/blog/inline-editing-project.mdx
---
...
`createAuthHandler`, `apiProxy`, and `previewHandler` now **require** the *Signing Key* to be passed as a parameter.
