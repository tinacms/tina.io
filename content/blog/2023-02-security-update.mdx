---
seo:
  title: TinaCMS Security Alert for versions 1.0.0 to 1.0.9
title: 'TinaCMS Security Alert: Information for versions >= 1.0.0, < 1.0.9'
date: '2023-02-06T04:00:00.000Z'
last_edited: '2023-02-06T04:00:00.000Z'
author: TinaCMS Team
prev: content/blog/tina-v-1.1.4.mdx
next: content/blog/tinasaurus-docusaurus-starter.mdx
---
...
TinaCMS credentials like the API token are not considered especially vulnerable because they're for read-only access. Nevertheless, it may be a good idea to update them. More importantly, if your TinaCMS-enabled website has other credentials (eg. Algolia or Cloudinary API keys) you should rotate those keys immediately.

If you have any questions or concerns, please don't hesitate to reach out to our security team at [support@tina.io](mailto\:support@tina.io)
