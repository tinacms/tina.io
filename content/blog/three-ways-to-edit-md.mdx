...
You can’t use React Hooks on class components. That’s why Tina provides a [`RemarkForm`](/docs/guides/converting-gatsby-to-tina) component that uses the [Render Props](https://reactjs.org/docs/render-props.html) pattern.
