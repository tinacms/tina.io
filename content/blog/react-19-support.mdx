...
- **Peer dependencies** for `react` and `react-dom` have been updated to allow React 19. This now means TinaCMS will use your version of React over its internal version.
