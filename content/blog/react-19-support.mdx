...
With the latest release of `tinacms@2.x.x` and `@tinacms/cli@2.x.x`, TinaCMS now offers **full, production-ready support for React 19**. You can upgrade your projects to React 19 straight away—no blockers, no workarounds, and no waiting.
...
* **No breaking changes.**\
  If your project already works with TinaCMS, upgrading to React 19 is as simple as updating your dependencies.
