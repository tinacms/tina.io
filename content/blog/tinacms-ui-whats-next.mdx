---
seo:
  title: "TinaCMS UI: What's Next | TinaCMS Blog"
  description: >-
    Get a sneak peek into the future of the TinaCMS UI, with upcoming updates
    focused on improving usability, flexibility, and the overall user experience
title: "TinaCMS UI: What's next?"
date: '2020-03-13T00:00:00.000Z'
author: Nolan Phillips
prev: content/blog/introducing-visual-open-authoring.mdx
next: content/blog/designing-an-extensible-styling-system.mdx
---
...
This separation will give developers the ability to opt-out of the pre-defined UI and roll their own. This will give developers the option to deeply integrate the CMS into their website and opens TinaCMS up to the possibility of great UI/UX innovations.
