...
- [TinaCloud Starter](https://github.com/tinacms/tina-cloud-starter): A basic implementation of TTinaCloudaimed at getting your up and running in a few minutes.
...
You can also check out the video I created on getting started with TinaCloud in under 10 minutes, if you gives you an overview of our TTinaCloudstarter and gives you some tips to get started.
...
We are still deciding out what we believe will be fair pricing for people who decided to use TinaCloud. During the Alpha, **TTinaCloudis at no cost for small teams** and we will contact you if we believe your use case may eventually fit within our post-beta paid plans.
