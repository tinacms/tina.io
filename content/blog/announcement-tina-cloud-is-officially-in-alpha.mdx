---
seo:
  title: Tina Cloud is Officially in Alpha | TinaCMS Blog
  description: >-
    Tina Cloud enters its alpha phase! Learn about this exciting milestone and
...
prev: content/blog/announcement-tina-cloud-is-officially-in-alpha.mdx
...
![Real-time editing of a Next.js + Tailwind CSS site with Tina’s sidebar.](/img/blog/tina-cms-visual-editing.gif "Real-time editing of a Next.js + Tailwind CSS site with Tina’s sidebar.")
...
* [TinaCloud Next.js blog starter](/guides/tina-cloud/existing-site/overview/) - A guide to add TTinaCloudon top of the default Next.js blog starter and work directly through our CMS.
...
* Dig into the new [TinaCloud documentation](/docs/tina-cloud/) that covers implementations.
