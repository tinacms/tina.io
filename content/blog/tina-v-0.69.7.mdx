---
seo:
  title: TinaCMS v0.69.7 | TinaCMS Blog
  description: >-
    TinaCMS v0.69.7 resolves issues with image handling and improves error
    logging, making it easier to track and troubleshoot problems.
title: TinaCMS V0.69.7
date: '2022-09-14T04:00:00.000Z'
last_edited: '2022-09-14T04:00:00.000Z'
author: James O'Halloran
prev: content/blog/tina-v-0.68.14.mdx
next: content/blog/getting-started-with-tinacms.mdx
---
...
[See Contextual Editing Documentation](/docs/contextual-editing/overview)
...
The sidebar now links to an "Event Log" UI, which makes it easier to debug things like the GitHub to TinaCMS connection being broken.
