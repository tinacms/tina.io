...
Tina also allows for ["Visual Editing"](https://tina.io/docs/tinacms-lingo) when used with React. This is a setup that allows your **website and editor window to sit side-by-side**, showing your changes in real-time.
