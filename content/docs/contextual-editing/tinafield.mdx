...
last_edited: '2025-03-17T22:41:15.502Z'
next: ''
previous: ''
---
...
> **Note**: The `object` property only needs to contain the nearest ancestor of the field you're trying to access. If the field is the object itself you may omit `property` and pass it in as a single argument.
