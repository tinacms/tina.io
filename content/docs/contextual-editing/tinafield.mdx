...
last_edited: '2025-03-17T01:02:34.133Z'
next: ''
previous: ''
---
...
## Using with custom React components
...
### Passing the full data object response

A less ideal solution would be to pass the response from Tina directly into our component, allowing us to cherry pick the field we want from the object. This approach works well for components with multiple layers of nesting
