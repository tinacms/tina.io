...
last_edited: '2025-03-17T05:42:35.212Z'
next: ''
previous: ''
---
...
By using a `forwardRef` we can apply the `[data-tina-field]` attribute to the React component directly. We then pass the attribute to the corresponding HTML using the spread operator.
