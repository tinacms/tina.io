...
last_edited: '2025-03-17T05:49:00.647Z'
next: ''
previous: ''
---
...
Tina's "click to edit" feature allows editors to select the HTML element they want to click on the page in order to see it in the sidebar.
...
Adding `[data-tina-field]` directly to a react component can be a bit tricky because React doesn't allow you to define attribute names with kebab casing. Here are some work arounds you can use.
