...
last_edited: '2025-06-23T00:50:16.575Z'
next: ''
previous: ''
---
...
> The props object that the custom `DataTime` component passes has the metadata stored under `_content_source` which is automagically applied when in edit mode (using tinacms).
...
React components can't take arbitary HTML attributes like data-tina-field. To work around this, define a prop (e.g. tinaField) and pass it down to an HTML element inside the component:\\
