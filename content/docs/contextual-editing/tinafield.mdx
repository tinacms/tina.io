...
last_edited: '2025-03-17T05:32:54.442Z'
next: ''
previous: ''
---
...
The easiest way to assign \[data-tina-field] in a React component is by using a custom attribute, allowing the tinaField helper's output to be passed as a string directly.
