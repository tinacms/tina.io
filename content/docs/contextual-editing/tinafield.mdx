...
last_edited: '2025-03-17T01:11:57.524Z'
next: ''
previous: ''
---
...
This approach is a little tricker to get right in a type safe manner. Using a forwardRef instead of a component we can apply the `[data-tina-field]` attribute to the React component being edited. The attribute gets passed in directly when we use the spread operator.
