...
last_edited: '2025-03-17T01:16:17.183Z'
next: ''
previous: ''
---
...
* The \[data-tina-field] helper does not affect the flow of data from Tina. It simply determines which part of the form Tina will open when the user clicks a given element.
