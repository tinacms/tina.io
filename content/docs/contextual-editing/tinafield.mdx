...
last_edited: '2025-03-17T03:06:01.037Z'
next: ''
previous: ''
---
...
This approach is a little tricker to get right in a type safe manner. By using a `forwardRef` we can apply the `[data-tina-field]` attribute to the React component being edited. The attribute gets passed in directly when we use the spread operator on `props`.
