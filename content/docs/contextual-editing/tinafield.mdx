...
last_edited: '2025-06-23T00:44:20.832Z'
next: ''
previous: ''
---
...
The tinaField helper reads this \_content\_source metadata to construct the correct path for the editor UI to connect the field with the form.
