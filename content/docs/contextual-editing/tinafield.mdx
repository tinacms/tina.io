...
last_edited: '2025-06-23T00:56:01.359Z'
next: ''
previous: ''
---
...
When using TinaMarkdown with custom components, the props object passed into each component already includes the \_content\_source metadata. This metadata is automatically injected in edit mode via Tina's useTina hook.
...
This links to the template component inside of tinacms. 
...
This gives Tina a more precise mapping to the field, based on the template definition used in your collection schema. 
