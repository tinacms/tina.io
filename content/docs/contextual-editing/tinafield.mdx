...
last_edited: '2025-03-17T01:08:05.081Z'
next: ''
previous: ''
---
...
A less ideal solution would be to pass the outer object housing the field we want from Tina. This allows us to cherry pick the field. While this approach works well for fields with multiple layers of nesting, it can make it difficult to figure out which element we can edit contextually from a glance.
