...
last_edited: '2025-03-17T01:13:42.083Z'
next: ''
previous: ''
---
...
* The \[data-tina-field] helper does not affect the flow of data from Tina. It simply determines which part of the form Tina will open when the user clicks a given element. For example, I may use a TinaMarkdown element
