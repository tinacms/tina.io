...
last_edited: '2025-03-17T05:40:43.464Z'
next: content/docs/contextual-editing/react.mdx
previous: content/docs/features/data-fetching.mdx
---

When you define a collection, TinaCMS gives you access to a full-page editor window to add you content.
...
For pages to update as you edit, you'll need to re-hydrate the pages data. 
