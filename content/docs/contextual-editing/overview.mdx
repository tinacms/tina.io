...
cmsUsageWarning: 'https://github.com/tinacms/tinacms/blob/main/packages/tinacms/src/toolkit/react-sidebar/components/sidebar-no-forms-placeholder.tsx'
seo:
  title: What is Visual Editing in TinaCMS?
  description: 'Discover how Visual Editing works in TinaCMS. Learn how live content editing is enabled with the useTina hook in React, and watch a video tutorial to get started.'
title: What is Visual Editing?
last_edited: '2026-03-25T03:20:50.803Z'
