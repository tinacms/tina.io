...
![A commit authored solely by the user, making it clear who made the change.](/img/docs/tinacloud/github-authoring/github-authoring-commit-example.png "The commit and PR is created by the user, not the bot.")
...
![The user settings UI showing the toggle to enable / disable the GitHub Authoring settings.](/img/docs/tinacloud/github-authoring/github-authoring-toggle.png "Toggle the setting via the GitHub Authoring profile settings.")
...
![The user settings UI showing the input fields for the Git co-authoring settings.](/img/docs/tinacloud/github-authoring/co-authoring-input-fields.png "Co-author details are manually entered via the Git Co-authoring profile settings.")
