...
<WarningCallout
  body={<>
    **Astro users:** deploy to Workers, not [Cloudflare Pages](/docs/tinacloud/deployment-options/cloudflare-pages). The `@astrojs/cloudflare` adapter [no longer supports Pages](https://docs.astro.build/en/guides/integrations-guide/cloudflare/), and the starter's visual-editing route (`src/pages/tina-island/[name].ts`) is server-rendered, so a static Pages upload breaks click-to-edit.
  </>}
/>
