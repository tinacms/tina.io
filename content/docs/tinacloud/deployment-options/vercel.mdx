...
![Ignored Build Step for running Bash scripts](/img/docs/tina-cloud-deployment-options/vercel-bash.png "Ignored Build Step for running Bash scripts")
...
![Ignored Build Step for stopping all automatic deployments](/img/docs/tina-cloud-deployment-options/vercel-dont-build.png "Ignored Build Step for stopping all automatic deployments")
...
![Token creation screen](/img/docs/tina-cloud-deployment-options/vercel-tokens.png "Token creation screen")

Then navigate to your project **Settings | General | Project ID** and copy the **`Project ID`** from there.

![Location of the Project ID to copy](/img/docs/tina-cloud-deployment-options/vercel-project-id.png "Location of the Project ID to copy")

Next, navigate to your project and copy the site URL, e.g. [https://mycoolblog.vercel.app/](https://mycoolblog.vercel.app/).

![Location of the project URL to copy](/img/docs/tina-cloud-deployment-options/vercel-site-url.png "Location of the project URL to copy")
...
![Location of the User ID to copy](/img/docs/tina-cloud-deployment-options/vercel-user-id.png "Location of the User ID to copy")
...
![GitHub Repo Secrets Creation Page](/img/docs/tina-cloud-deployment-options/repo-secrets-creation.png "GitHub Repo Secrets Creation Page")
...
![Successful and failed GitHub Actions](/img/docs/tina-cloud-deployment-options/github-actions.png "Successful and failed GitHub Actions")
