...
last_edited: '2025-11-25T23:16:30.192Z'
...
Use Vercel's built-in functionality - follow the [Ignore Build Step Guide](https://vercel.com/docs/project-configuration/git-settings#ignored-build-step) to define a Bash or Node script to reject deploying certain builds conditionally.

Set your **`Ignore Build Step`** to **`Run my Bash script`** or **`Run my Node script`**.

![](/img/docs/tina-cloud-deployment-options/Vercel%20Bash.png)Figure: Ignored Build Step for running Bash scripts
...
![](/img/docs/tina-cloud-deployment-options/Vercel%20Dont%20Build.png)Figure: Ignored Build Step for stopping all automatic deployments
...
****![](/img/docs/tina-cloud-deployment-options/Vercel%20Tokens.png)Figure: Token creation screen

In Vercel, navigate to your project **Settings | General | Project ID** and copy the **`Project ID`** from there.

![](/img/docs/tina-cloud-deployment-options/Vercel%20Project%20Id.png)Figure: Project ID to copy

In Vercel, navigate to your project and copy the site URL, e.g. [https://mycoolblog.vercel.app/](https://mycoolblog.vercel.app/).

![](/img/docs/tina-cloud-deployment-options/Vercel%20Site%20URL.png)Figure: Project URL to copy
...
![](/img/docs/tina-cloud-deployment-options/Vercel%20User%20Id.png)Figure: User ID to copy
