...
Go to your project's **Settings > Git**. You'll find options related to **`Deploy Hooks`** and **`Ignore Build Step`**
...
> ⚠️ **Both options**: Due to the way Vercel is configured internally, every commit to a tracked branch will still count towards your quotas and concurrent build count
...
Navigate to your project **Settings > Project ID** and copy the **`Project ID`** from there.
...
Go to your **GitHub project > Actions** and verify that your workflow is running.
