...
last_edited: '2026-04-28T12:59:19.280Z'
...
`projects` directory of your repository, the Path To Tina Field would be `projects/my-site` .

Example setup for Path to Tina Field = projects/my-site
...
![](/docs/path-to-tina-folder.png "Path to Tina Folder UI under Advanced Settings")**Figure: **
