...
To deploy your site to production, you'll need to connect Tina to a hosted backend. This doc will walk you through the steps to get your site from [running locally to running for production](/docs/troubleshooting/authentication-login-issues/#local-mode-vs-production-mode).
...
* Make sure you have a [TinaCloud](https://app.tina.io) account.
  * Check out the [TinaCloud Dashboard](/docs/tinacloud/dashboard) docs for more information.

## Make a TinaCloud Project

Go to [app.tina.io](https://app.tina.io) and create a new [project](/docs/tinacloud/dashboard/projects/). You'll be asked to connect your Github account and select the repository you want to connect to TinaCloud.
