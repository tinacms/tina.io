...
Once we've defined a collection, we can edit its fields through the TinaCMS UI, or [query its content](/docs/graphql/overview/) using the TinaCMS Content API.
