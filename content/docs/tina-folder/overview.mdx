...
seo:
  description: Overview of the tina folder in TinaCMS, including configuration, schema, and UI customization details.
last_edited: '2024-12-22T23:04:54.683Z'
next: ''
previous: ''
---
...
The `tina` folder is normally at the root of the repo (unless a [mono repo setup](/docs/introduction/faq/#does-tina-cloud-work-with-monorepos) is being used). It has the following folder structure:
...
See our ["TinaCloud Starter"](https://github.com/tinacms/tina-cloud-starter/blob/main/tina/config.tsx) for an example of how this file is used. The default export of the file must be `defineConfig({})`.
