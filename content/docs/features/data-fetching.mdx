...
title: Data Fetching
nextP: content/docs/contextual-editing/overview.mdx
...
<div style="position:relative;padding-top:56.25%;">
  <iframe width="560" frameborder="0" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" src="https://www.youtube.com/embed/PcgnJDILv4w?start=403&end=534" title="TinaCMS Deep Dive (Data Fetching)" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" />
</div>
