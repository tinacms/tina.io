...
last_edited: '2025-03-26T03:56:47.644Z'
...
Okay, you're right, it can definitely be more concise and to the point. Let's trim it down.

Here's a more direct version of that section:
...
export default defineConfig({
  schema,
  token: '***', // Not needed in local-mode
  clientId: '***', // Not needed in local-mode
  branch: 'main', // Not needed in local-mode
});
```
