...
These projects can be used as a development environment for TinaCMS packages, you can edit any other package contained within TinaCMS packages.
...
This command will build all TinaCMS packages. This will reflect in the references of the tina demo packages, thus updating the demo packages according to the changes made.
