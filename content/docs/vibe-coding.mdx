...
Install via our [TinaCMS Starter CLI tool](https://tina.io/docs/introduction/using-starter), or paste this prompt into your AI assistant:
...
The TinaCMS Starter CLI tool will generate a new folder named after your project and install everything required to run TinaCMS into it.
...
> **Tip:** To learn how to make a great AGENTS.md file read the SSW Rule [Write an AGENTS.md](https://www.ssw.com.au/rules/write-agents-md)
...
## 3. Master the TinaCMS-Specific Patterns

Help your AI understand TinaCMS's unique architecture.

### 3.1 Schema First

TinaCMS starts with the schema. Instead of asking for a page, ask for the schema definition first.
...
```plaintext
Generate the TypeScript interface for this component based on the TinaCMS query response.
```
...
* If it forgets TinaCMS: Remind it explicitly:
...
Your job is to keep it aimed in the right direction by understanding TinaCMS’s patterns, giving clear prompts, and staying hands-on.
