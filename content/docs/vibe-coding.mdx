...
AI works best when it has context. Having the template gives it some code to model itself on. Use our [Tina Starter CLI tool](https://tina.io/docs/introduction/using-starter) or ask your assistant to do it for you with a prompt like the one below:
