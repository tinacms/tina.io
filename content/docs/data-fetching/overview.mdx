...
last_edited: '2025-03-26T03:56:55.695Z'
...
There are **two methods **for filtering documents by filename: implementing a **[custom query](/docs/data-fetching/custom-queries/) **or filtering an existing collection of documents **in code**.
