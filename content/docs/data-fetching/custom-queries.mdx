...
For most simple cases, you should be able to leverage the TinaCMS Client's generated queries to do your data fetching:
...
TinaCMS generates custom [GraphQL fragments](https://graphql.org/learn/queries/#fragments) to be used in custom queries so that the queries will not have to be updated when the schema is updated.
