...
seo:
  description: Learn how to query and retrieve single documents in TinaCMS using GraphQL, including examples of working with relative paths
title: Querying a Single Document
last_edited: '2025-01-24T05:11:06.105Z'
next: ''
previous: ''
---
