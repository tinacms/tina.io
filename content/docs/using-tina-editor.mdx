...
seo:
  description: Learn how to use the Tina Editor, from logging in to the admin interface to managing your content through the visual editing interface
---
...
![](/img/docs/add-folder-tinacms_c8pxte.png)\
...
> Note: You can learn more about how to set up **contextual-editing** for your users [here](/docs/contextual-editing/overview).
...
- Learn how [Tina can be extended](/docs/extending-tina/overview) to create new field components
