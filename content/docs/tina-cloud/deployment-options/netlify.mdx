...
seo:
  description: Guide to deploying TinaCMS projects to Netlify, including build configuration and environment variable setup.
...
![Netlify build config](/img/docs/tina-cloud-deployment-options/build-settings.png 'Netlify build config')
