...
This can happen for a number of reasons but here is the most common reason and fix:

#### 1. Lacking entry file for GitHub Pages

GitHub Pages will look for entry file for the website, it will dislay a 404 error page if you don't have such entry file at the top level of the source folder on the source branch.

To fix this, you'll need to add a file named `index.tsx` to `./pages`. The content of the file should be:
