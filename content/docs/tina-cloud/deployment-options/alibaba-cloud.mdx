...
TinaCMS primarily implements automatic content repository updates through GitHub and Vercel integration, but Vercel is blocked in mainland China. Therefore, Chinese users can choose to deploy their projects to Chinese service providers' servers as an alternative.


Based on our current testing (as of July 10, 2025), here is the accessibility status of TinaCMS-related services in mainland China without VPN:
...
Given these limitations, this guide will walk you through deploying your TinaCMS project to Alibaba Cloud, which is the most common cloud service provider in China and offers reliable performance for Chinese users.

Alibaba Cloud is the leading cloud service provider in China. Since China doesn't have any cloud service offers seamless integration with GitHub like Vercel, Alibaba Cloud becomes the go-to option for developers who want to deploy their websites within mainland China.
