...
last_edited: '2025-02-19T07:30:12.545Z'
...
1. SSH\_PRIVATE\_KEY : The private key generated on your server
   * View it using: cat \~/.ssh/id\_ed25519
   * Make sure to include the entire key, including the -----BEGIN OPENSSH PRIVATE KEY----and -----END OPENSSH PRIVATE KEY-----
2. SERVER\_HOST: Your Alibaba Cloud server's IP address
   * This is the public IP address of your ECS instance
3. SERVER\_USERNAME: The username for connecting to your server
   * Typically root or the user account you created on your ECS instance
4. NEXT\_PUBLIC\_TINA\_BRANCH: The branch that Tina CMS should use for content
   * Usually your main branch (e.g., main  or master)
5. NEXT\_PUBLIC\_TINA\_CLIENT\_ID: Your Tina Cloud client ID
   * Find this in your Tina Cloud dashboard under project settings
6. TINA\_TOKEN: Your Tina Cloud token for authentication
