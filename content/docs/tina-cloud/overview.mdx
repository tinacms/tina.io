...
seo:
  ...
  description: Introduction to TinaCloud, a hosted content management solution that provides authentication, media handling, and content APIs
title: Going to Production with TinaCloud
last_edited: '2024-12-16T03:59:37.444Z'
...
<WarningCallout body="Note: If you're loading your schema config values from a local environment file, Tina's build process will only pickup `.env` files (not `.env.local` or `.env.development`)" />
