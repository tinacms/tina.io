...
last_edited: '2025-07-14T01:06:54.114Z'
next: ''
previous: ''
---
...
![A commit clearly showing the user's avatar and name as the author.](/tina-cloud-app-good-example.png "With authorship configured, contributions are clearly attributed.")
