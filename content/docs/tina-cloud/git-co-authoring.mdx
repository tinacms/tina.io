...
![](/tina-cloud-app-bad-example.png "❌ Bad Example - Who made this change?")
...
![](/tina-cloud-app-good-example.png "✅ Good Example - I can track down Ben Neoh about this change")
