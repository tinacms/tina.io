...
title: TinaCloud FAQ
seo:
  description: 'Find answers to frequently asked questions about the TinaCloud Alpha release, including features, technical considerations, and support options.'
---
...
- Have a look at the updated [TinaCloud docs](/docs/setup-overview/) and try out a starter.
- [Sign up for TinaCloud](https://app.tina.io/register)!
...
- [Next.js](https://nextjs.org/) - The flexibility of this fantastic React framework lowers the bar to build with TinaCloud.
