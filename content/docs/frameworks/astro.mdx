...
Learn more about [content modeling](/docs/schema/).
...
If you want to leverage TinaCMS's API for real-time editing, you can enable Visual Editing. To enable Visual Editing with TinaCMS we have had to use React components and a new client\:tinaDirective.
