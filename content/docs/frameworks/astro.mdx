...
last_edited: '2026-06-08T22:36:48.811Z'
...
There are two ways you can get started with Tina and Astro.

### 1. Pre-existing Project
...
### 2. From a Starter Template

Alternatively, you can scaffold from the React-free starter template:
