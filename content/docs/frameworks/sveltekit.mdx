...
* [Astro setup guide](/docs/frameworks/astro/) - Another modern framework option
* [Remix setup guide](/docs/frameworks/remix/) - React-based alternative
* [Next.js setup guide](/docs/frameworks/next/app-router/) - Most popular React framework
