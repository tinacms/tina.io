...
Make it known via [GitHub discussions](https://github.com/tinacms/tinacms/discussions "GitHub discussions"):
...
> Popularity can be seen from [Google Trends](https://trends.google.com/trends/explore?q=nuxt%20web,hugo%20web,astro%20web,Gatsby%20web,11ty%20web\&hl=en "google trends frameworks")
...
<WarningCallout
  body={<>
    If you are getting error when running this command please see the [Common Errors](/docs/forestry/common-errors) page.
  </>}
/>
...
![block-based-editing-visual](/gif/blocks.webm)
