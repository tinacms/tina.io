...
seo:
  description: Universal guide for setting up TinaCMS with any web framework, with focus on framework-agnostic features and implementation approaches
---
...
> Note: popularity can be seen from [Google Trends](https://trends.google.com/trends/explore?q=nuxt%20web,hugo%20web,astro%20web,Gatsby%20web,11ty%20web\&hl=en "google trends frameworks")
