...
next: content/docs/frameworks/remix.mdx
previous: content/docs/frameworks/gatsby.mdx
---
...
* [Hugo setup guide](/docs/frameworks/hugo/) - Similar static site generator
* [11ty setup guide](/docs/frameworks/11ty/) - Another popular SSG option
* [Next.js setup guide](/docs/frameworks/next/app-router/) - For React-based sites
