---
seo:
  title: 'Hybrid SSG & Dynamic Rendering in Next.js'
  description: >-
    Fetching data on the client side across branches while keeping static site
    generation intact with the TinaCloud API.
...
Here is the documentation on [fetching content across branches](/docs/features/data-fetching#fetching-content-across-branches-in-tinacms)
