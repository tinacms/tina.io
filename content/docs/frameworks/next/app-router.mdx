...
last_edited: '2025-03-06T00:50:12.310Z'
...
1. Manually updating the default re-validation time for route segments. Find more information here: [https://nextjs.org/docs/app/api-reference/file-conventions/route-segment-config#revalidate](https://nextjs.org/docs/app/api-reference/file-conventions/route-segment-config#revalidate)
2. Pass { cache: 'no-store' } as an additional parameter to fetch requests to force the fetching of latest content. Find more information here: [https://nextjs.org/docs/app/api-reference/functions/fetch#optionscache](https://nextjs.org/docs/app/api-reference/functions/fetch#optionscache)
