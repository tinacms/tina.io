...
seo:
  description: >-
    Set up TinaCMS with Next.js Pages Router. Learn configuration steps, best
...
* [Next.js App Router setup](/docs/frameworks/next/app-router/) - Modern routing with React Server Components
* [Visual Editing setup](/docs/contextual-editing/overview/) - Enable live preview editing
* [Other framework guides](/docs/frameworks/astro/) - Astro, Hugo, Gatsby, and more
