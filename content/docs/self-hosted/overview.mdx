...
previous: content/docs/tinacloud/api-versioning.mdx
---
...
- [Database Adapter](/docs/reference/self-hosted/database-adapter/overview)
  - Handles indexing and interaction with the [database](/docs/troubleshooting/graphql-api-issues/#why-do-i-need-a-database-when-using-markdown) (e.g. MongoDB, Postgres, etc.)
...
> Note: Some features are not available when self-hosting TinaCMS. See the [Self-hosted Limitations](/docs/troubleshooting/tinacloud-vs-self-hosted/#what-features-are-unavailable-in-self-hosted-tina) section for more info.
