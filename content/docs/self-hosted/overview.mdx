...
> Note: Some features are not available when self-hosting TinaCMS. See the [Self-hosted Limitations](/docs/tina-cloud/faq/#what-features-are-unavailable-in-self-hosted-tina-compared-to-tinacloud) section for more info.
