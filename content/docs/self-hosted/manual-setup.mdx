...
Now you should be able to run your site and use TinaCMS to edit your content. See the docs [Hosting the API docs](/docs/self-hosted/graphql-endpoint/overview/) for more info on how to self-host TinaCMS.
