...
TinaCMS provides two database adapters in the init workflow: "Redis" (VercelKV) & "MongoDB". Learn more about [Database Adapters](/docs/reference/self-hosted/database-adapter/overview/).
