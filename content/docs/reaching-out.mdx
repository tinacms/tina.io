...
1. `tina-lock.json` – check your TinaCMS lock-file is up to date. You can manually update it by running the CMS locally with `tinacms dev` (typically this is a part of your dev run command). This resolves the majority of user issues related to indexing. [Learn more](https://tina.io/docs/support#tina-lockjson).
