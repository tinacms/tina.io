...
title: Draft Fields
next: content/docs/tinacloud/editorial-workflow.mdx
...
Read more about [querying data](/docs/data-fetching/overview).
...
- The above solution won't work as-is with [visual editing](/docs/contextual-editing/overview). To setup visual editing with drafts, you will need to implement [NextJS Preview-Mode](/docs/guides/contextual-drafts).
