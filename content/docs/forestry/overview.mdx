...
title: Forestry Migration Overview
next: content/docs/forestry/migrate.mdx
previous: content/docs/features/data-fetching.mdx
seo:
  description: Overview of migrating from Forestry.io to TinaCMS, with comparison of features and benefits of switching
---
...
TinaCMS is focused on providing live, [in-context editing](https://tina.io/docs/contextual-editing/overview/ "in-context editing") capabilities, while Forestry.io offers a more traditional approach to content management. This means that with TinaCMS, you can see your changes as you make them, while with Forestry.io, you have to preview your changes in separate window. These previews currently work [with React pages](https://tina.io/docs/contextual-editing/react/ "react visual editing"), and Vue support [is being considered](https://github.com/tinacms/tinacms/discussions/3460 "vue discussion"). 
