...
seo:
  description: Compare content modeling approaches in TinaCMS and Forestry.io, exploring the differences between code-based and UI-based content model creation
---
