...
seo:
  description: Overview of Forestry.io features not yet available in TinaCMS, including planned features, features under consideration, and unsupported features
---

<WarningCallout body="This page is out of date and won't be updated – active support plans exist and can be found on the [TinaCMS GitHub](https://github.com/tinacms/tinacms/discussions) and [official roadmap](https://tina.io/roadmap/)" />
