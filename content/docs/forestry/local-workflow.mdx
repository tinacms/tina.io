---
title: 'Comparing TinaCMS & Forestry: Local Workflow'
...
## Schema changes in TinaCMS, using "local-mode"

In TinaCMS, you can run the TinaCMS dashboard locally alongside your site. If you want to do a migration (E.g, renaming a field), you can test everything out locally with the CMS before pushing anything to git. When you're ready, everything gets pushed to Git together.
