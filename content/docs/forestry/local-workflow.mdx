...
seo:
  description: Compare local development workflows between TinaCMS and Forestry.io, focusing on schema changes and the advantages of Tina's local-mode testing
---
