---
title: 'Comparing TinaCMS & Forestry: Data Files'
...
Some features like setting up select-fields to references arrays in a data-file are not yet available in TinaCMS.
