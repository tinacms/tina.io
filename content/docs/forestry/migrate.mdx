...
For more information on deploying Tina with Netlify, Vercel, or GitHub Pages, [see this doc](/docs/tinacloud/overview/#deploying-your-site-with-the-tinacms-admin)
