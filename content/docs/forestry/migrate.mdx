...
<Youtube embedSrc="https://www.youtube.com/embed/OHY8PyeLK1g" />

## Getting Started

> Note: This TinaCMS Migration will change your site's content files. Please back up your site's content before proceeding. This is best done by doing a git commit before proceeding.
...
You can lean more about content modeling in TinaCMS's [content modeling docs](https://tina.io/docs/schema/).

## Deploy TinaCMS to your site
...
Push your repo up to git, along with its new TinaCMS configuration.

### Step 2) Set up a TinaCloud project

In production, we'll want to make sure only authorized users can access your TinaCMS admin, and make changes to your content. You can set up a [TinaCloud project](https://app.tina.io/) to handle this.
Once your project is created, you'll also need to generate a read-only-token.

See our [TinaCloud docs](https://tina.io/docs/tinacloud/) for help using TinaCloud.

### Step 3) Connect the TinaCloud config to your site
...
TinaCMS's build will need to be apart of your site's static generation.
...
![](/img/docs/forestry-migration/build-settings.png)

For more information on deploying TinaCMS with Netlify, Vercel, or GitHub Pages, [see this doc](/docs/tinacloud/overview/#deploying-your-site-with-the-tinacms-admin)

### Step 5) Start using TinaCMS!
