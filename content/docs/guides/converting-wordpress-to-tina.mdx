...
last_edited: '2024-11-08T01:46:07.717Z'
next: ''
previous: ''
---
...
> 💡 Note: This only works because the format of WordPress posts matches the format that the Tina Starter uses.
...
### Adding Post's Cover Image Example
...
> 💡 **Hint**: You can copy or rename the `heroImg` code snippet and edit to fit your needs
