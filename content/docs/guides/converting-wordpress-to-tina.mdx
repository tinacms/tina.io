...
* You have set up a [TinaCMS starter](https://tina.io/docs/introduction/using-starter)
* Have a basic understanding of using the [TinaCMS Editor](https://tina.io/docs/using-tina-editor) and [the schema](https://tina.io/docs/schema)
...
Using the [TinaCMS editor](https://tina.io/docs/using-tina-editor), you can update the hero image of each post.
