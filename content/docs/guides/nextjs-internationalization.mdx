...
seo:
  description: Guide on implementing internationalization in Next.js with TinaCMS, using content sub-folders and i18n routing.
---
...
![Create Locale Document](/img/docs/nextjs-internationalization/subfolder-create-new.png)
...
![Editing English](/img/docs/nextjs-internationalization/subfolder-edit-en.png)
...
![Editing French](/img/docs/fr/subfolder-edit-fr.png)
