...
last_edited: '2025-12-10T01:59:28.118Z'
next: ''
previous: ''
---
...
Add your **Tina Content Query**, **Tina Token** and **Tina Client ID** to the `.env` file. These are the same properties added be to your [GitHub Settings](/docs/guides/content-auditing-github-actions#secrets).
