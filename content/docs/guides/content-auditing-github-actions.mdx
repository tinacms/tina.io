...
last_edited: '2025-12-10T06:31:45.458Z'
next: ''
previous: ''
---
...
You may optionally override the default system propmpt by providing your own as a GitHub variable. The value to override is `TINA_AUDITOR_SYSTEM_PROMPT`. The default system prompt is as follows:
