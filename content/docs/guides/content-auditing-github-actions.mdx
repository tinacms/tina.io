...
last_edited: '2025-12-10T00:11:28.611Z'
next: ''
previous: ''
---
...
<scrollBasedShowcase
  showcaseItems={[
    ...
    },
    {
      ...
      image: "",
      content:
        "After scanning your content the GitHub action will produce a list of issues with suggested improvements for each content item. This feedback will be based on your system prompt.\n",
    ...
    },
    {
      ...
      image: "",
      content:
        "GitHub models will read and evaluate your content against System prompt you've provided, flagging any potential areas for improvement. **Mistral 3B** is used by default.\n",
      useAsSubsection: false
    }
  ]}
/>
...
Enable GitHub Actions your repo:
...
You'll need to add configuration settings that will be used when the GitHub action is run. To configure the se settings go to Your Repo > ⚙️Settings > Secrets and Variables.
...
Once you've finished setting up the GitHub action for your own project you should be able to see a new workflow called **Audit Content with AI** in the GitHub Actions for your repo. You can run it manually to perform your first conent audit.
...
The flow will output a separate issue for each file it audited. Each issue will contain feedback for the issue audited.![](/img/docs/content-audit-github-actions/issues-audit-action.png "Issue list after running content audit action")
