...
last_edited: '2025-12-10T00:28:48.647Z'
next: ''
previous: ''
---
...
The flow will output a list of issues after the conntent audit is finished. Each issue will contain a list of suggestions for the content and a handy link to the file that needs to be changd.![](/img/docs/content-audit-github-actions/issues-audit-action.png "Issue list after running content audit action")
