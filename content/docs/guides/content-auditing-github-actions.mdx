...
last_edited: '2025-12-09T04:14:36.772Z'
next: ''
previous: ''
---
...
In order to start auditing you content with AI we first need to add a field to the colleciton you'd like to query.
...
> Be sure to run your project at last once after making the above schema changes (i.e. by running `pnpm dev`). This will rebuild you `tina-lock.json` file including the new field.
...
**NOTE: Your query must include the following variables**
