...
last_edited: '2024-10-31T01:19:56.884Z'
next: content/docs/cli-overview.mdx
previous: content/docs/contextual-editing/overview.mdx
---

<WarningCallout body="Some TinaCMS features are not supported in Gatsby. For [Visual Editing](https://tina.io/docs/contextual-editing/overview/), we recommend migrating to Next.js." />

## Introduction

[Gatsby](https://www.gatsbyjs.com/) is an open-source SSG (Static Site Generation) framework.

In this tutorial, we'll guide you through converting an existing `gatsby-mdx` blog to TinaCMS. 

## Caveats

There are a few limitations to using Gatsby with TinaCMS:
...
First, clone our sample Gatsby project. This is a fork of the official [Gatsby MD blog starter](https://www.gatsbyjs.com/starters/gatsbyjs/gatsby-starter-blog).

 Then you'll want to navigate into the gatsby-mdx-example-blog directory.
