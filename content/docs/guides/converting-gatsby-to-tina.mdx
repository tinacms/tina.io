...
Once you've made sure you have the right version of node installed clone the project we'll be using for this tutorial. Afterwards you'll want to change into the directory for the blog.
