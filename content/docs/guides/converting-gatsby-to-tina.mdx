...
In this tutorial, we'll guide you through converting an existing `gatsby-mdx` blog to use TinaCMS. We've provided a starter repo for you to follow along, which is a fork of the official [Gatsby md blog starter](https://www.gatsbyjs.com/starters/gatsbyjs/gatsby-starter-blog).
