...
Inside `onCreateNode`, create a new node with an [Abstract Syntax Tree (AST)](https://tina.io/docs/editing/markdown/#rendering-content-with-tinamarkdown) compatible with TinaMarkdown. Then we'll serialize it a string for easy retrieval in your page query.
