...
last_edited: '2024-11-08T04:34:49.317Z'
...
To fix any bugs related to conflciting graphlQL versions inside of node modules we'll also force the versions of graphql to be the same as TinaCMS in package.json.
