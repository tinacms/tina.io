...
last_edited: '2024-11-10T23:59:53.780Z'
...
You can create React components in Gatsby as well. First, we'll modify the schema for our blog posts, defining the new React component we're planning to add.
