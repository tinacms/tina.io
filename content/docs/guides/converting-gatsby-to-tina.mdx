...
last_edited: '2024-10-29T22:54:47.993Z'
...
Now our project is set up to use TinaCMS. There's a problem though: our project is still using Gatsby's mdx parser instead of TinaCMS's. We'll need to do some tweaking to get it working. First, we'll edit the graphql query inside of `gatsby-node.js` so that it returns raw markdown.
