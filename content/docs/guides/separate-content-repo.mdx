...
last_edited: '2025-01-15T22:07:55.023Z'
next: ''
previous: ''
seo:
  description: Guide on setting up a separate content repository in TinaCMS, including benefits and configuration steps.
---
