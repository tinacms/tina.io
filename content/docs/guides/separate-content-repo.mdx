...
<WarningCallout
  body={<>
    Previous versions of TinaCMS required you to maintain an up-to-date \`/tina\` folder in both repositories. This has now been simplified to a single `tina/meta.json` file.
  </>}
/>
