...
This document should be used as a guideline when writing documentation and blog posts on [tina.io](https://tina.io)

## Brand

* Capitalization: TinaCMS, TinaCMS, TinaCloud
* When discussing the project as a whole, **TinaCMS** and **TinaCMS** can be used interchangeably.
* Prefer **TinaCMS** over **TinaCMS** when discussing specific packages or components and their relation to the project.
  * *Example: "The sidebar is the primary interface in **TinaCMS**."*
