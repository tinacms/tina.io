...
Create `src/pages/tina-island/[name].ts`, the single dynamic route the bridge POSTs to. Copy from the [starter](https://github.com/tinacms/tina-astro-starter/blob/main/src/pages/tina-island/%5Bname%5D.ts).
