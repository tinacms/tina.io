...
The **"Direct references only"** checkbox filters the tree to show only documents that are **directly referenced** by the page you're on. These are documents pulled in via TinaCMS's APIs from your code.
