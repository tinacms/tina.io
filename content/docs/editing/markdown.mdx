...
title: Markdown & MDX
nextP: content/docs/editing/blocks.mdx
...
Tina also provides a `<TinaMarkdown>` component, which renders your `md` or `mdx` component from the *parsed AST*.
...
![Docs\_Starter\_Example](https://res.cloudinary.com/forestry-demo/video/upload/v1638887594/blog-media/Docs_Starter_Example.gif)

> How does MDX work with Tina?Tina doesn't require a compilation step like other MDX tooling you
