...
TinaCMS supports block-based editing, so that your editors can build out full pages using your pre-defined blocks (i.e. **page sections**).
...
> For more info on how to query data with TinaCMS's GraphQL API, check out the [Query Documentation](https://tina.io/docs/graphql/queries/)
