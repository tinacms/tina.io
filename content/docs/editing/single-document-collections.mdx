...
<video className="video" autoPlay="true" loop muted playsInline src="https://res.cloudinary.com/forestry-demo/video/upload/q_100,h_584/e_accelerate:-20/tina-io/docs/extending-tina/Single_Collection_Demo.webm" poster="https://res.cloudinary.com/forestry-demo/video/upload/so_0/tina-io/docs/extending-tina/Single_Collection_Demo.jpg">
  <source src="https://res.cloudinary.com/forestry-demo/video/upload/q_100,h_584/e_accelerate:-20/tina-io/docs/extending-tina/Single_Collection_Demo.webm" type="video/webm" />

  <source src="https://res.cloudinary.com/forestry-demo/video/upload/q_80,h_584/e_accelerate:-20/tina-io/docs/extending-tina/Single_Collection_Demo.mp4" type="video/mp4" />

  <source src="https://res.cloudinary.com/forestry-demo/video/upload/q_100,h_584/e_accelerate:-20/tina-io/docs/extending-tina/Single_Collection_Demo.mov" type="video/mov" />
</video>
