...
title: Tina Docs
last_edited: '2025-03-10T21:58:29.187Z'
tocIsHidden: true
...
Tina doesn't lock you into a proprietary database and you control your content in the form of Markdown, MDX, and JSON files stored with the power of Git.

Continue on for a quick **2 minute rundown of TinaCMS**, and how it fits into your website.
...
<scrollBasedShowcase
  showcaseItems={[
    ...
    },
    {
      title: "Headless CMS",
      image:
        "https://assets.tina.io/06bcd49e-f919-4e53-a2c4-77f656491c7d/img/docs/product-tour/Copy of Hosting ( (2).png",
      content:
    ...
    },
    {
      ...
      image:
        "https://assets.tina.io/06bcd49e-f919-4e53-a2c4-77f656491c7d/img/docs/product-tour/Copy of Copy of Copy of Copy of Hosting ( (4).png",
      content:
    ...
    },
    {
      title: "Saving",
      image:
        "https://assets.tina.io/06bcd49e-f919-4e53-a2c4-77f656491c7d/img/docs/product-tour/Hosting ( (4).png",
      content:
...
Tina uses Git to provide a single source of truth for content and code. Content changes go straight to your repository, meaning version control and content history.

### Real-time visual editing

Create and edit content directly in the context of your website or application with Tina's real-time visual editor. Take advantage of Tina with content blocks for an editing experience similar to WordPress and other popular tools.
