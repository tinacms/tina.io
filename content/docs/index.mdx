...
last_edited: '2026-03-24T04:21:59.696Z'
tocIsHidden: true
...
<mark style="background-color: #FEF08A">Tina doesn't lock you into a proprietary database.</mark> You control your content in the form of Markdown, MDX, and JSON files stored with the power of Git.
