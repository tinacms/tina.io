...
title: Tina Docs
last_edited: '2025-03-10T05:45:27.377Z'
tocIsHidden: true
...
<scrollBasedShowcase
  showcaseItems={[
    ...
    },
    {
      ...
      content:
        "The TinaCMS backend provides the GraphQL API for querying your content, offering support for filtering, searching, and pagination.\n",
      useAsSubsection: false
    },
    {
