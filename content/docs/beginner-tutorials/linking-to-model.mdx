...
2. Add an amazing title, a beautiful image, and an incredible body!

3. Examine the `Hello-World.md` file in your IDE. You'll see the shape of it has changed, and our templates/content are now all stored in front-matter.
