...
last_edited: '2026-01-07T23:27:17.805Z'
tocIsHidden: true
...
1. Navigate to `http://localhost/admin/index.html` and edit your amazing title and see how the changes are immediately reflected in the HTML.

2. Click "Save", and navigate back to `http://localhost:3000` to see your changes persisted on your "production" site.
