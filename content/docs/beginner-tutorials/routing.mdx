...
last_edited: '2025-03-18T23:52:31.297Z'
tocIsHidden: true
...
> Match your filename from the content directory, the filename might be different if you set your title to something other than Hello World!

We can make this better later, but for now let's just roll with it.
