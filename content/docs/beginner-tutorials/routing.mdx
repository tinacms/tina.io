...
last_edited: '2025-03-18T23:59:06.388Z'
tocIsHidden: true
...
> The router lets Tina know which pages are going to be used for live editing, but also creates a link to that page from the collection list (instead of to the regular editor).
