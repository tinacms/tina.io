...
last_edited: '2026-01-07T23:17:30.050Z'
tocIsHidden: true
next: content/docs/beginner-tutorials/wiring-content.mdx
previous: content/docs/beginner-tutorials/live-editing.mdx
---

Right now, if we want to edit our amazing title, we have to go into the TinaCMS editor, find our collection, and then edit the record in our collection before we can view our changes. 😮‍💨
...
First up, this particular router is only for the TinaCMS visual editor. It does not control any routes of your actual site - that's still controlled by our NextJS App Router.
...
1. Open your app by going to `http://localhost:3000` and you should see your awesome "Hello World!" title.

2. Now open the visual editor again by going to `http://localhost:3000/admin/index.html`

**OMG**! We can see our homepage in the editor! 🎉

> The router lets TinaCMS know which pages are going to be used for live editing, but also creates a link to the Visual Editor page from the collection list.
