...
last_edited: '2026-02-04T22:00:10.938Z'
...
The `slugify` function is useful when you want to have a file name that is *derived* from other field(s) in your collection. For example: you could have a filename.
