...
last_edited: '2026-02-04T21:58:12.158Z'
...
## Option A: using slugify

The `slugify` function is useful when you want to have a file name that is *derived* from other field(s) in your collection. use the filename customization API, you need to pass a `slugify` function that allows you to customize the filename of a document based on its content.
