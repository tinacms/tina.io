...
alias: Any-
last_edited: '2026-02-04T22:39:52.229Z'
...
Using the parse function you can enforce file constraints within the Tina editor. The callback function you provide will be used to sanitise the user input while they're typing. For Example: you could use the parse function to enforce sanke case naming conventions.
    ...
    collections: [
      {
        ...
        ui: {
          filename: {
            parse: (filemame) => filemame.replaceAll(" ","_"),
          }
        },
        name: "post",
        path: "content/post",
