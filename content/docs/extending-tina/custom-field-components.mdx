...
last_edited: '2025-03-17T05:18:21.974Z'
...
Any field in the collection can be updated with `form.change` – `form.change(name: string, value: any) => void`, using the field `name` property.
