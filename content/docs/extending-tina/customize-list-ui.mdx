...
next: content/docs/extending-tina/format-and-parse.mdx
previous: content/docs/extending-tina/custom-field-components.mdx
seo:
  description: Learn how to customize list item labels and rendering in TinaCMS to improve the editing experience with more meaningful item representations
---
