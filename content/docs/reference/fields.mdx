...
id: fields
title: Fields
last_edited: '2025-03-26T00:57:06.497Z'
...
<apiReference
  ...
  property={[
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "Defines the field is linked to the Markdown body.\n\n*Text* (`rich-text` and `string`) fields only.\n",
      default: "false"
    },
    {
      name: "options",
...
<WarningCallout
  body={<>
    This name cannot have spaces, dashes, or special characters. It must be a
    valid GraphQL name.
  </>}
/>
...
<WarningCallout
  body={<>
    This is not supported for reference field types.
  </>}
/>
