...
id: fields
title: Fields
last_edited: '2024-09-12T05:55:41.615Z'
...
The minimum can apply to all field types with list `list: true` specified, provided they appear as a list in the editor. Specifically, this is the:
