...
seo:
  description: 'Comprehensive guide to defining fields in TinaCMS, including properties, examples, and customization options.'
---
...
| `description`  | A short description about the field that will be displayed to the user (_optional_, can include html formatting e.g. style attributes)                                                                                                                                                                                                                                |
