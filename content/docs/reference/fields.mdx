...
* [Reference Field Types](/docs/reference/types/reference/) cannot be set as a list. To work around this, they can [be wrapped](/docs/reference/types/object/#simple-wrapper-field) in an object field type that has been been marked with `list: true`.
