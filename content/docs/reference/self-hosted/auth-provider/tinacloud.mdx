---
title: TinaCloud Auth Provider
id: '/docs/reference/self-hosted/auth-provider/tinacloud'
---

You can use TinaCloud for authentication and authorization and self-host the content api. If you do not already have account,
