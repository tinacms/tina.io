...
We're considering support for additional database adapters for common databases in the future, if this interests you let us know in [GitHub discussions](https://github.com/tinacms/tinacms/discussions "GitHub discussions").
