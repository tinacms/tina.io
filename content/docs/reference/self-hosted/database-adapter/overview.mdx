...
| `levelBatchSize`      | Number of operations per database write batch during indexing. Optional, defaults to 25. Increase for adapters that process operations in parallel within a single batch call.                                                                                                                 |
