...
next: content/docs/reference/types/string.mdx
previous: content/docs/reference/templates.mdx
seo:
  description: Overview of field types in TinaCMS, including string, number, datetime, boolean, image, reference, object, and rich-text types.
---
