---
id: /docs/reference/types/image
title: Image Field
next: content/docs/reference/types/number.mdx
previous: content/docs/reference/types/group.mdx
seo:
  description: Documentation for TinaCMS's image field type, supporting image uploads, previews, and integration with various media providers
