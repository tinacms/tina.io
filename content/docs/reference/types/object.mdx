...
last_edited: '2024-09-26T06:50:55.855Z'
...
* with `list` set to `true`, the `fields` array contains the data structure to be repeated – this appears in the editor as above, but grouped as a list. Complex lists can be created.
