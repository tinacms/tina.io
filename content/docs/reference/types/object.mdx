---
id: /docs/reference/types/object
title: Object Field
next: content/docs/reference/types/reference.mdx
previous: content/docs/reference/types/number.mdx
seo:
  description: Documentation for TinaCMS's object field type, enabling nested data structures with multiple sub-fields and customizable layouts
