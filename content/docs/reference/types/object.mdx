...
last_edited: '2024-11-26T03:04:32.457Z'
...
<recipeBlock
  title="Scenario Recipe"
  description="The solution to the scenario described above. "
  code="import type { Template } from 'tinacms';

  export const FeatureTemplate: Template = { 
      label: 'Feature Block',
  name: 'featureBlock',
  fields: [
  {
