...
last_edited: '2024-09-26T06:17:32.863Z'
...
* with `list` set to `false`, the `fields` array can be used to wrap some data – this appears in the editor as a nested page.

![](https://res.cloudinary.com/forestry-demo/image/upload/v1727331124/tina-io/docs/Sep-26-2024_16-05-37_d2ol8w.gif)

* with `list` set to `true`, the `fields` array can to set some set of fields – this appears in the editor as above, but grouped as a list.
