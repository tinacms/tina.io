...
last_edited: '2026-03-04T10:02:37.038Z'
next: ''
...
<apiReference
  property={[
    ...
    {
      name: "overrides",
      description: "Toolbar override and customisation options.\n",
...
The `overrides` property controls a series of overrides and customisations to
