  ...
  property={[
    {
      ...
      description: "Select which toolbar options are displayed. The following
      options are supported: [heading, link, image, quote, ul, ol, bold,
      italic, code, codeBlock, mermaid, table, raw, embed].\n",
    },
    {
