...
last_edited: '2024-10-17T04:55:54.280Z'
next: ''
previous: ''
---
...
![supported-table-cell-formats](https://res.cloudinary.com/forestry-demo/image/upload/v1729139341/TinaCMS/supported-table-formats_bgpvq2.png)**✅ Figure: Good example - Supported table cell formats **
