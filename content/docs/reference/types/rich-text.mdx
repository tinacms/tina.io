  ...
  property={[
    {
      ...
      description: "Select which toolbar options are displayed. The following options are supported: [heading, link, image, quote, ul, ol, bold, italic, code, codeBlock, mermaid, table, raw, embed].\n",
    },
    {
      name: "showFloatingToolbar",
      description: "Whether the rich-text Floating Toolbar is enabled or disabled.\n",
      type: "boolean",
    },
  ]}
/>
