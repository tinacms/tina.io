...
last_edited: '2025-03-16T22:06:24.197Z'
next: ''
previous: content/docs/reference/rich-text-usage/mermaid.mdx
---

The rich-text field gives a WYSIWYG interface, supporting features like text formatting, links, media and custom elements (if used with mdx).
...
<WarningCallout body="`&#x22;children&#x22;` should not be used as the `name` for rich-text fields, as it conflicts with other parts of the application." />
