---
id: /docs/reference/types/rich-text
title: Rich Text Field
next: content/docs/reference/types/select.mdx
previous: content/docs/reference/types/reference.mdx
seo:
  description: Documentation for TinaCMS's rich text field type, providing a WYSIWYG editor with formatting tools and customizable features
---
