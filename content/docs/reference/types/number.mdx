...
seo:
  description: >-
    Learn how to use the Number field in TinaCMS, including configuration
    options and best practices for handling numeric values in your schema.
title: The "number" field
last_edited: '2025-03-06T00:51:43.198Z'
next: ''
previous: ''
---
