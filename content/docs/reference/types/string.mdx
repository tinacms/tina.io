---
id: /docs/reference/types/string
title: String Field
last_edited: '2024-09-12T01:52:13.442Z'
next: content/docs/reference/types/textarea.mdx
previous: content/docs/reference/types/select.mdx
seo:
  description: Documentation for TinaCMS's string field type, the basic text input field with support for validation and formatting options
---
