...
last_edited: '2024-08-26T00:34:21.044Z'
---
...
Example below show a page collection with author collection as it's reference field. The `reference field` has been extract into a module.
...
Here are the UI of custom reference field in the example above.![](https://res.cloudinary.com/forestry-demo/image/upload/v1724068658/reference_field/custom-reference-field-ui_ojtrlx.png)****
...
Recommended Implementation for Custom Reference Selection with Type Safety.
