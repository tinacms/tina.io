...
![](https://res.cloudinary.com/forestry-demo/image/upload/v1723170767/Screenshot_2024-08-09_123142_a2jona.png)

> Note: `reference` with custom display in the option list on support reference with field 'label'/'name'. Customize reference field with choosen field still under implementation. See [issue](https://github.com/tinacms/tinacms/issues/4707)
