...
file name will be display in the reference field selector
...
> Note: `reference` display in the option list only support reference that have field `label` or `name`. Customize reference field with choosen field still under implementation. See [issue](https://github.com/tinacms/tinacms/issues/4707)
