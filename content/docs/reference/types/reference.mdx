...
last_edited: '2024-09-12T00:48:14.741Z'
next: ''
previous: ''
---
...
> Note: `reference` with `list: true` is not currently supported. Object type lists can be used [as a wrapper](/docs/reference/types/object/#using-list-object-as-a-wrapper-for-other-types) where a reference list is needed.
