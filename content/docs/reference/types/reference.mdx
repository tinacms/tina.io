---
id: /docs/reference/types/reference
title: Reference Field
next: content/docs/reference/types/rich-text.mdx
previous: content/docs/reference/types/object.mdx
seo:
  description: Documentation for TinaCMS's reference field type, allowing content relationships and cross-referencing between documents
---
