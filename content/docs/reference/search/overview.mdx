---
id: /docs/reference/search/overview
title: Search Overview
last_edited: '2023-06-08T04:00:00.000Z'
next: content/docs/reference/search/cloud.mdx
previous: content/docs/reference/media/overview.mdx
seo:
  description: Guide to implementing search functionality in TinaCMS, including configuration options and integration with different search providers
---
