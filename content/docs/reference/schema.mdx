...
| `config.clientId` | The ClientId [generated on TinaCloud](/docs/tinacloud/dashboard/)                          |
| `config.token`    | A read only token [generated on TinaCloud](/docs/tinacloud/dashboard/projects/#api-tokens) |
