...
seo:
  description: Overview of field plugins in TinaCMS, including default plugins like Text, Textarea, Number, Image, Color, Toggle, and Select.
---

<WarningCallout body="This page is outdated, a current equivalent exists on the [Custom Field Components](/docs/extending-tina/custom-field-components/#default-field-plugins) page" />
