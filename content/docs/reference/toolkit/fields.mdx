...
<WarningCallout
  body={<>
    This page is outdated, a current equivalent exists on the [Custom Field Components](/docs/extending-tina/custom-field-components/#default-field-plugins) page
  </>}
/>
