...
<WarningCallout body="This page has is outdated, a current equivalent exists on the [Custom Field Components](https://tina.io/docs/extending-tina/custom-field-components/#default-field-plugins) page" />
