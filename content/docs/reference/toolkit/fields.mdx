...
<WarningCallout body="This page has been depreciated, a current equivalent exists on the [Custom Field Components](https://tina.io/docs/extending-tina/custom-field-components/#default-field-plugins) page" />
...
* [Color](/docs/reference/toolkit/fields/color) *May be external soon*
