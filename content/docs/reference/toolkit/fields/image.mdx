...
title: Image Field
last_edited: '2024-11-05T05:31:20.520Z'
next: ''
previous: ''
---
...
| `previewSrc`  | Defines the path for the src attribute on the image preview. If using gatsby-image, the path to the `childImageSharp.fluid.src` needs to be provided. *(Optional)*                                                       |
