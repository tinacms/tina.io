...
| `defaultItem` | Provides the `list` items with default data upon being created. Returns an empty string if no value is provided. *(Optional)*                                                                                                                                                                                                                                                                                                                                                                                         |
...
> This interface only shows the keys unique to the list field. Visit the [Field Config](/docs/extending-tina/custom-field-components/#default-field-plugins) docs for a complete list of options.
