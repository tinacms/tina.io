...
> FieldConfigThis interfaces only shows the keys unique to the group field.Visit the [Field Config](/docs/extending-tina/custom-field-components/#default-field-plugins "link to custom field components") docs for a complete list of options.
