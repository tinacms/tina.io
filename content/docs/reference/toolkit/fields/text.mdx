...
> This interfaces only shows the keys unique to the text field.Visit the [Field Config](https://tina.io/docs/extending-tina/custom-field-components/#default-field-plugins "custom field link") docs for a complete list of options.
