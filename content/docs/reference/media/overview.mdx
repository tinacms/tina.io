---
id: /docs/reference/media/overview
title: Media Manager Overview
last_edited: '2024-11-12T22:59:50.498Z'
next: content/docs/reference/media/cloud.mdx
previous: content/docs/cli-overview.mdx
seo:
  description: Overview of TinaCMS's Media Manager for handling images and assets, including configuration options and supported storage providers
---
