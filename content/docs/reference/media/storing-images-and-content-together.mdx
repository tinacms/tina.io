...
last_edited: '2025-06-23T15:03:53.708Z'
next: ''
previous: ''
---
...
This separation works in many modern web frameworks (like Next.js, Astro, etc.) where static assets are served from a public directory, but it breaks self-containment — your content and its assets live in different locations. This adds friction when managing, duplicating, or migrating content.
...
<Youtube embedSrc="https://www.youtube.com/watch?v=bmf1uNFyNKg" minutes="5" caption="The 3 options for storing markdown in GitHub for TinaCMS (Images and content)" />
