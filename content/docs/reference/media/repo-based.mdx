...
This has other benefits such as reducing dependencies, usage of external APIs and syncronization between local development and preview environments.
...
Learn more about [Next.js remote patterns](https://nextjs.org/docs/app/api-reference/components/image#remotepatterns).
