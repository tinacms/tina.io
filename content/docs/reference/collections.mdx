...
id: collections
title: Collections
last_edited: '2025-03-24T06:14:18.243Z'
...
The typical convention is to add a collection for a given React component to an accompanying file of the same name with the suffix `collection.tsx`. This ensures that the index for your site is only rebuilt when changes are made to your data model. You'll still be able to itera
