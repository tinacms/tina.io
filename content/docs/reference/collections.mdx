...
id: collections
title: Collections
last_edited: '2025-03-24T06:11:54.366Z'
...
The typical convention is to add a collection for a given component to a file of the same name ending in an accompanying file called `collection.tsx` assuming you're using typescript. This ensures that the index for your site is only rebuilt when changes are made to your data model. You'll still be able to itera
