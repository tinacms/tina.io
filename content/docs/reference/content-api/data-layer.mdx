...
TinaCloud runs the Data Layer for you as a managed service. It syncs with your GitHub repository via webhooks and maintains the index automatically. Each project gets its own GraphQL endpoint. You can also [host your own Data Layer](/docs/self-hosted/overview) as an alternative.
