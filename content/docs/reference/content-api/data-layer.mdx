...
- Changes to the [path to tina](/docs/tinacloud/dashboard/projects/#path-to-tina)
- Changes to the configured [repository](/docs/tinacloud/dashboard/projects/#changing-the-repository)
