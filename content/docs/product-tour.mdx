...
![Website-png](/img/docs/product-tour/headless_cms1.png)
...
![self-hosted-backend-png](/img/docs/product-tour/self-host-backend.png)
...
![admin-route](/img/docs/product-tour/admin.png)

### Saving

- When users make a change in the CMS, a commit is made back to your Git repository.

![saving-png](/img/docs/product-tour/git-save.png)
...
![cli-init-png](/img/docs/product-tour/cli-init.png)
...
![local-tina](/img/docs/product-tour/local-workflow.png)
...
![type-safety-png](/img/docs/product-tour/client-typesafe.png)
