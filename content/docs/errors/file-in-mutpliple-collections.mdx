...
seo:
  description: Resolve the file in multiple collections error in TinaCMS by properly configuring collection paths and match properties to avoid overlapping
---
