...
seo:
  description: Solutions and workarounds for handling list property limitations in TinaCMS field types, including using object fields and alternative approaches
---
