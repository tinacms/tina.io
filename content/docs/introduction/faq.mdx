...
## 5. What features are unavailable in self-hosted Tina compared to TinaCloud?
...
## 5. How to enable co-author on Git commits?
...
## 6. Why do I need a database when using markdown?
...
## 7. What is "Local Mode" vs "Prod Mode"?
...
## 8. Does TinaCloud only work with GitHub repositories?
...
## 9. Does TinaCloud work with Monorepos?
...
## 10. Why does Tina.io login window doesn't close when logging in from a site?
...
## 11. How do I resolve "Failed loading TinaCMS assets" error?
...
## 12. What are the common TinaCloud errors?
...
### 2. How do I resolve `The local GraphQL schema doesn't match the remote GraphQL schema.` errors?
...
### 4. How do I resolve `There was a problem saving your document` errors?
...
### 5. How do I resolve `Invalid or undefined branch` errors?
...
### 6. How do I resolve `tina directory not pushed to git` errors?
...
## 13. How to to access local GraphQL server when it's not running or in prod?
...
## 14. Vercel Deployment Issues -  What are the common issues when deploying starter templates?
