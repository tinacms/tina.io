...
4. Pull down the branch into your TinaCloud project. <Youtube embedSrc="https://youtube.com/embed/GDAQle7Q-sY" /> **Video: TinaCloud - How to index missing branches (3 min)**
5. You can also force a branch into your TinaCloud project by making a whitespace change to the `tina/tina-lock.json` file in that branch, committing it, and pushing it to GitHub. This will initiate indexing for the branch, and (after a few minutes) the error should be resolved
