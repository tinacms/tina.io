...
Yes, Tina is designed for developers. You’ll need someone with dev experience to set it up and customize it properly. A [certified developer](https://www.credly.com/org/superior-software-for-windows-ssw/badge/tinacms-developer) should be involved to ensure best practices.
