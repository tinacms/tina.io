---
title: FAQ
last_edited: '2025-02-21T00:24:50.971Z'
next: ''
previous: ''
---
...
and more. It also grants authorization for other users (content creators, editors, marketers, etc) to login and edit their site without needing to grant direct access to the repository in GitHub. TinaCMS can be [self-hosted](/docs/self-hosted/overview) or used independently of TinaCloud as well.
