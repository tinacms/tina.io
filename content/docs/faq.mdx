...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:27:52.992Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created are not indexed. TinaCMS branches need trigger the branch create event to be indexed.
