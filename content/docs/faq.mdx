...
title: FAQ
alias: FAQ
last_edited: '2026-02-05T22:30:25.636Z'
next: ''
previous: ''
---
...
TinaCMS is supported on all LTS versions of Node. See [Node.js Releases](https://nodejs.org/en/about/previous-releases) to find out more about release versions.

NPM, PNPM and Yarn package managers are all supported.

| Node Version |                                                                  |
| ------------ | ---------------------------------------------------------------- |
| v25.x        | ✅ Supported - current but not LTS                                |
| v24.x LTS    | ✅ Supported - recommended for production                         |
| v23.x        | ✅ Supported - however recommended to upgrade since v23.x is EoL  |
| v22.x LTS    | ✅ Supported - good for production                                |
| v21.x        | ✅ Supported - however recommended to upgrade since v21.x is EoL  |
| v20.x LTS    | ✅ Supported - recommended to update                              |
| v19.x        | ❌ EoL                                                            |

Table updated Feburary 2026
