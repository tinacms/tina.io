...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:52:41.149Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created by assigning work to GitHub copilot will fail to build. Currently branches created by GitHub Copilot do not trigger the branch creation webhook we rely on to begin indexing your content. We have logged a ticket with GitHub regarding this and will post any progress updates in this [Issue](https://github.com/tinacms/tinacloud/issues/3243).
