...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:46:50.314Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created by assigning work to GitHub copilot will fail to build. TinaCMS begins indexing branches when they are created against your repository, triggering a webhook on your repository to start indexing content. For more information track the progress on this [issue](https://github.com/tinacms/tinacloud/issues/3243).
