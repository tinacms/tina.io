...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:49:00.705Z'
next: ''
previous: ''
---
...
* Aligned with LLM trends – Markdown fits naturally with the shift toward LLM-optimized content, as highlighted in [SEO is Dead, Long Live LLMO](https://jina.ai/news/seo-is-dead-long-live-llmo)
...
Due to a limitation with GitHub Copilot's webhook system, branches created by assigning work to GitHub copilot will fail to build. TinaCMS begins indexing branches when they are created against your repository, triggering a webhook on your repository to start indexing content. 

Currently branches created by GitHub Copilot do not trigger GitHub's normal webhooks. We have logged an issue with GitHub and will keep progress on this issue updated accordingly [issue](https://github.com/tinacms/tinacloud/issues/3243).

As a workaround for the time being, GitHub copilot branches can be manually re-indexed within the tina cloud dashboard
