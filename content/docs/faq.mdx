...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:44:22.873Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created by assigning work to GitHub copilot will fail to build. TinaCMS branches need trigger the branch create event to be indexed. For more information track the progress on this [issue](https://github.com/tinacms/tinacloud/issues/3243).
