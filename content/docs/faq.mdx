...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:33:39.499Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created are not indexed. TinaCMS branches need trigger the branch create event to be indexed. For more information track the progress on this [issue](https://github.com/tinacms/tinacloud/issues/3243).
