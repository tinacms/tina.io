...
title: FAQ
alias: FAQ
last_edited: '2026-02-09T04:50:39.916Z'
next: ''
previous: ''
---
...
Due to a limitation with GitHub Copilot's webhook system, branches created by assigning work to GitHub copilot will fail to build. Currently branches created by GitHub Copilot do not trigger GitHub's normal webhooks. We have logged a ticket with GitHub regarding this and will post any progress updates in this GitHub [issue](https://github.com/tinacms/tinacloud/issues/3243).
