...
banner:
  ...
  locationLink: 'https://www.ssw.com.au/offices/melbourne'
  actionButton:
    title: Agenda
  rightButton:
    title: Register
...
speakers:
  ...
  - name: Calum Simpson
    position: Solution Architect
    image: /img/people/Calum-Simpson.jpg
...
speakerSchedule:
  ...
  - speechTitle: Registration & Breakfast
    ...
    sessionType: Break
  - speechTitle: Lunch
    speechDescription: "We're providing lunch from the foodie streets of Melbourne \U0001F37D️"
    talkSpeakerImage: /img/people/Tina.png
    talkTimeStart: 12
    talkTimeEnd: 13
    sessionType: Break
  ...
  - speechTitle: 'Optimizing AI Development: MCP Servers & Cursor Workflows'
    ...
    talkTimeEnd: 15
    sessionType: Talk
  - speechTitle: 'Hacking Content Creation: Building a TinaCMS MCP Prototype'
    speechDescription: >-
      In this session, I'll walk you through an experimental Tina MCP Server — a
      prototype for generating and managing TinaCMS content using MCP workflows.
      We'll cover how it was built, ways you could extend it with other MCP
      Servers, and what it suggests about the future of CMS development. 
    talkSpeakerName: Calum Simpson
    talkSpeakerImage: /img/people/Calum-Simpson.jpg
    talkTimeStart: 15
    talkTimeEnd: 16
    sessionType: Talk
---
