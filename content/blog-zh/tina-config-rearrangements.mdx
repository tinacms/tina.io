---
seo:
  title: TinaCMS 配置重组 | TinaCMS 博客
  description: >-
    对 TinaCMS 配置的重要重组，提升了自定义能力并简化了设置过程，为开发者提供了更好的体验。
title: TinaCMS 配置重组
...
TinaCMS 的最新版本增加了对 `<root>/tina` 新配置文件夹的支持。

## 简要说明

* TinaCMS 配置现在位于 `tina/config.{ts,tsx,js,jsx}`。`.tina` 配置仍然可以使用。
