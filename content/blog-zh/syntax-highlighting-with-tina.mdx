...
## 你可以在哪里了解TinaCMS的最新动态？

你知道你会想成为这个充满创造力、创新性、支持性的开发者社区（甚至还有一些编辑和设计师）的一部分，他们每天都在实验和实施TinaCMS。
...
我们的Twitter账号（[@tinacms](https://twitter.com/tinacms)）宣布TinaCMS的最新功能、改进和抢先预览。如果你在你构建的项目中标记我们，我们也会非常兴奋。