...
<WarningCallout
  body={<>
    **更新**: Tina API一直在演变，本文中的内容已过时。要获取Tina的入门帮助，我们建议查看我们的[入门文档](/zh/docs/setup-overview)。
  </>}
/>

Tina采用以开发者为中心的方法来构建内容，这意味着你可以在你喜欢的编辑器中本地建模你的内容。得益于存储在你仓库中的[文件上的GraphQL层](/zh/blog/using-graphql-with-the-filesystem/)，Tina使得在所有文件中查询内容变得更加简单。让我们看看这是什么感觉。
