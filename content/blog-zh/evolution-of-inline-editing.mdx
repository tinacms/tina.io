...
在这个讨论中，我们不能忘记侧边栏编辑！内联编辑的吸引力往往掩盖了我们通过侧边栏编辑获得的灵活设置和可用性优势。**我们建议从[侧边栏编辑](/zh/docs/using-tina-editor)开始，以快速启动和运行。**

## 原始方法的回顾

让我们来看一个简单的[内联编辑](/zh/docs/contextual-editing/overview)场景，在这里我们使页面的标题可编辑。
...
但这种方法有[一些权衡](/zh/blog/more-changes-coming-to-inline-editing/)：
