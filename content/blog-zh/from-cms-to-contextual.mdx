...
> 如果您想了解这个示例是如何创建的，请查看涵盖[开始使用Tina](/zh/blog/tina-cms-get-started)的博客文章。
...
* [通过Cloudinary进行媒体管理](/zh/docs/reference/media/external/cloudinary)
* [路由映射 - 将CMS连接到可视化编辑](/zh/docs/contextual-editing/overview)
