---
seo:
  title: TinaCMS v0.68.14 | TinaCMS 博客
  description: >-
...
TinaCMS 版本 `0.68.14` 为 TinaCMS 带来了一些广泛的改进。以下是一些主要功能的简要列表：
...
令牌必须是通配符令牌 (`*`)，可以从 TinaCMS 仪表板生成。阅读更多关于只读令牌的信息 [这里](https://tina.io/blog/read-only-tokens-content-anytime)

有关如何获取这些值的更多信息，请参阅 ["going to production"](/docs/tinacloud/overview/#enabling-tina-cloud-in-tinacms) 文档。
