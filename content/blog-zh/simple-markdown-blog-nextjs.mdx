...
*想直接使用Tina与Next.js？[查看我们的快速入门](/docs/setup-overview "TinaCMS快速入门")*
...
在搭建好基于 Markdown 的博客网站之后，您很可能需要一个 CMS（[内容管理系统](https://en.wikipedia.org/wiki/Content_management_system)）来让编辑和更新您的文章或数据变得更加容易。敬请期待**下一篇关于如何使用 TinaCMS 配置此入门项目的博客**。在此期间，您可以查阅我们的[文档](/docs)，或者[尝试一个入门项目](/docs/introduction/using-starter)来立即开始体验 TinaCMS。
