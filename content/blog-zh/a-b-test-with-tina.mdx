...
> 如果你想了解更多关于所有不同字段类型及其使用方法的信息，请查看我们的[内容建模文档。](/zh/docs/schema)
...
> 你可能注意到了`ui`属性。我们使用它来为列表项提供更具描述性的标签。你可以在我们的[扩展Tina文档](/zh/docs/extending-tina/customize-list-ui)中了解更多。
