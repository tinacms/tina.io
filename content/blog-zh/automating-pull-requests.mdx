...
保持与 TinaCMS 同步的最佳方式是订阅我们的新闻通讯，我们每两周发送一次更新。更新包括新功能、我们正在进行的工作、你可能错过的博客文章等等！

你可以通过以下链接订阅并输入你的电子邮件：[/community](/community)

### TinaCMS 社区 Discord

TinaCMS 有一个社区 [Discord](https://discord.com/invite/zumN63Ybpf)，里面充满了 Jamstack 爱好者和 TinaCMS 爱好者。加入后你会发现一个地方：
...
我们的 Twitter 账号 ([@tina\_cms](https://twitter.com/tina_cms)) 宣布最新的功能、改进和 TinaCMS 的抢先预览。如果你在构建的项目中标记我们，我们也会很高兴。