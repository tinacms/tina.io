...
> **注意：** 本文已过时。有关最新的Tina使用，请[查看我们的文档](/zh/docs)。

最新的更新使开发人员能够将`validation`、`component`和`parse`函数直接放入架构中。

## 如何更新

> 如果您想开始使用tina，请查看[这个入门指南](/zh/docs/setup-overview/)
...
> 在我们的参考文档中[阅读更多](/zh/docs/tina-folder/overview/#tinadynamicproviderjs)关于这两个文件的信息
...
我们在本文中讨论的新功能只是可能性的冰山一角，请[阅读文档](/zh/docs/)以了解更多信息。
