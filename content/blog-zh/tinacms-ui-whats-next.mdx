...
您可能已经注意到，[tinacms.org](https://tinacms.org) 上的编辑界面与我们的视频中以及您本地运行的界面不同。这个新的工具栏是我们在 [tinacms.org 仓库](https://github.com/tinacms/tinacms.org 'GitHub: tinacms.org')中直接进行的一个实验。在这篇文章中，我将讨论我们为什么采取这种方法以及如何让 Tina 工具栏对所有人开放的下一步。
