...
这篇博客是探索使用 Next.js + Tina 系列的一部分。在[第一部分](/zh/blog/simple-markdown-blog-nextjs)中，您学习了如何使用 Next 创建一个简单的基于 Markdown 的博客。在这篇文章中，您将通过配置 TinaCMS 为网站添加内容编辑功能。

### Next.js 回顾 ▲

[Next.js](https://nextjs.org/) 是一个由 [Vercel](https://vercel.com/) 团队构建的用于开发 Web 应用程序的 **React “元框架”**（一个基于框架构建的框架）。阅读[第一部分](/zh/blog/simple-markdown-blog-nextjs/)以熟悉 Next.js 的基础知识。

### Tina 概述 🦙

[Tina](/zh) 是一个基于 Git 的无头内容管理系统，使开发人员和内容创作者能够无缝协作。使用 Tina，开发人员可以创建一个完全适合其网站的自定义可视化编辑体验。
...
本教程将向您展示如何安装和**配置 Tina 以编辑上周文章中创建的简单基于 Markdown 的博客**。如果您想深入了解基础博客的制作过程，请阅读本系列的[第一部分](/zh/blog/simple-markdown-blog-nextjs/)。

> 跳到这里查看 [Tina 文档](/zh/docs/setup-overview/)
...
> 在我们继续之前，您可以在我们的[文档](/zh/docs/schema/)中阅读更多关于内容建模的信息
