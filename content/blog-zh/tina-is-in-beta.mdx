...
Tina入门最初是为了展示“Tina的力量”而构建的，虽然它做到了这一点，但我们觉得它没有展示一个真实世界的例子。所以我们回到绘图板，创建了我们新的[Tina入门](/zh/docs/introduction/using-starter)，其中包括一个登陆页面、博客和关于页面。您可以编辑和重新排列内容，我们使用TailwindCSS对其进行样式化，使其更加闪亮！以下是您可以做的一些工作的示例：

<WebmEmbed embedSrc="/img/blog/tinacms-is-in-beta/edit-alongside-content.webm" />

## 媒体管理器

媒体管理器是我们为TinaCloud所需的最重要功能之一。我们的[Cloudinary媒体管理器](/zh/docs/reference/media/external/cloudinary/)允许您更改图像、上传新图像以及删除不再需要的图像，而无需离开Tina编辑体验。

我写了一篇[博客文章宣布它](/zh/blog/manage-your-media-with-cloudinary/)以及如何将其实现到您的应用程序中。
...
如果您使用了Tina的alpha版本，您可能想阅读这篇文章，团队编写了这篇文章来解释所有[变化以及如何迁移](/zh/docs/tinacloud/migration-overview/)。
