...
*本文不会涵盖在Gatsby中使用Tina的基础知识。请参考[文档](/zh/docs/guides/converting-gatsby-to-tina)了解如何最初设置Tina与Gatsby。*
...
鉴于在Gatsby中创建组件和获取数据的所有选项，我们必须为项目选择最合适的方法。Tina可以与所有这些选项一起工作，提供**[三种不同的方法](/zh/docs/guides/converting-gatsby-to-tina)**来编辑Gatsby中的Markdown，如下所述。
...
您不能在类组件上使用React Hooks。这就是为什么Tina提供了一个使用[渲染Props](https://legacy.reactjs.org/docs/render-props.html)模式的[`RemarkForm`](/zh/docs/guides/converting-gatsby-to-tina)组件。
...
这只是让您入门的基础。如果您喜欢Tina并想了解更多，您应该查看[官方文档](/zh/docs/)。那里有很多内容可以阅读，还有一些有趣的用例。

例如，您可以学习如何应用[内联编辑](/zh/docs/contextual-editing/overview)，以及如何在Tina侧边栏中[自定义表单字段](/docs/plugins/fields)。
