...
我们将使用[`object`类型](/zh/docs/schema/#grouping-properties-within-an-object)，并提供一个`templates`列表，其中每个“模板”代表一个独特的块类型。
...
> 有关如何使用Tina的GraphQL API查询数据的更多信息，请查看[查询文档](/zh/docs/graphql/queries)
