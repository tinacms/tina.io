...
title: 草稿字段
next: content/docs-zh/tinacloud/editorial-workflow.mdx
...
阅读更多关于查询数据的信息[这里](/zh/docs/data-fetching/overview)。

> 如果您在使用静态站点生成器（如Hugo）时使用了草稿字段，任何带有“draft: true”的文档将会被自动从您的生产站点中排除。

## 注意事项：

- 上述解决方案无法直接与[可视化编辑](/zh/docs/contextual-editing/overview)一起使用。要设置带有草稿的可视化编辑，您需要实现[NextJS预览模式](/zh/docs/guides/contextual-drafts)。