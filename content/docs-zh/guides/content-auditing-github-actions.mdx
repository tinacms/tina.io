  ...
  showcaseItems={[
    {
      ...
      image: "",
      content:
        "您的内容将在TinaCloud中查询。这为GitHub操作提供了需要定位的文件列表。\n",
...
| **TINA\_CLIENT\_ID** | 您项目的TinaCMS客户端ID。您可以在**TinaCloud \| Projects \| \<your-project> \|  ⚙️ 项目详情 \| 客户端ID**中找到它 |
...
您需要在此位置添加一个`.env`文件，并保存您的**Collection**、**TinaCMS Token**和**TinaCMS Client ID**。这些是您在[GitHub设置](/docs/guides/content-auditing-github-actions#secrets)中添加的相同属性。
