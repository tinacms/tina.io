...
seo:
  title: 使用TinaCMS实现国际化和多语言内容
  description: >-
    本指南涵盖了使用TinaCMS实现国际化的设置、配置和最佳实践，以提供无缝的多语言用户体验
title: 国际化
last_edited: '2025-04-14T09:08:52.001Z'
next: ''
previous: ''
---
...
> 有关设置NextJS特定实现的路由的更多信息，请参阅[我们的指南](/docs/guides/internationalization/)
