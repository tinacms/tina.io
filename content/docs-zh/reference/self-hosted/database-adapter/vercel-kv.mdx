...
Vercel KV 数据库适配器允许您在 TinaCMS 中使用 [Vercel KV](https://vercel.com/docs/storage/vercel-kv) 数据库。此适配器使用 [Upstash Redis 客户端](https://www.npmjs.com/package/@upstash/redis)，因此也可以与 [Upstash Redis](https://docs.upstash.com/redis) 一起使用。
