...
当您的项目启用了[编辑工作流](/zh/docs/tinacloud/editorial-workflow/)时，媒体变得**分支感知**，并与您的内容一起经过相同的审核流程：
...
查看[编辑工作流中的媒体](/zh/docs/tinacloud/editorial-workflow/#media-in-the-editorial-workflow)以了解完整流程。
