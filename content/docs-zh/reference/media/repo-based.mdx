...
如果您在非默认分支上配置 TinaCMS（且 TinaCMS 配置尚未合并到您的默认分支），项目创建时的自动媒体同步可能无法找到您的媒体配置。在这种情况下，您的 TinaCloud 项目仪表板中的**媒体**选项卡将显示媒体尚未同步。一旦您的 TinaCMS 配置合并到默认分支，您可以从该选项卡手动触发同步。
