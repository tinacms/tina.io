...
> 确保在推送到TinaCloud的生产环境时同时提交对配置和[`tina-lock.json`](/docs/tina-folder/overview/#tina-lockjson)文件的更改，否则你的资产仍将以`https://assets.tina.io`为前缀，就像你[仍在使用基于仓库的媒体](/docs/reference/media/repo-based/)一样。
