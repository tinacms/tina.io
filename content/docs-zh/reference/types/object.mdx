...
> 有关所有字段类型共有的其他属性，请查看[字段](/docs/reference/fields)类型定义。
...
要为某个模板获取图像，您需要提供带有模板的`ui.previewSrc`属性的图像。这是一个URL，或相对于您在TinaCMS配置中定义的[公共文件夹](/docs/reference/media/repo-based)。
