...
在 TinaCMS 中编辑时，用户将能够为 `author` 的值选择 `author` 集合中的一个文档。
...
<WarningCallout
  body={<>
    如果您引用的集合包含大量项目，则可能会遇到超时问题。查看 [FAQ - 加载引用字段时出现 503 服务不可用错误](https://tina.io/docs/introduction/faq#18-getting-a-503-service-unavailable-error-when-loading-the-reference-field) 以获取更多信息。
  </>}
/>
