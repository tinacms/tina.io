...
- 对 [tina 路径](/docs/tinacloud/dashboard/projects/#path-to-tina) 的更改
- 对配置的 [仓库](/docs/tinacloud/dashboard/projects/#changing-the-repository) 的更改
- GitHub 中的新分支
...
在分支上使用“重新索引”将丢弃 TinaCloud 中尚未推送到您仓库的该分支的任何更改。如果您需要从 TinaCloud 导出未保存的内容，可以使用 [导出分支](/docs/tinacloud/dashboard/projects/#export-branch) 按钮将您仓库的当前状态导出到一个新分支。