...
- [排序](/zh/docs/graphql/queries/advanced/sorting/)
- [过滤](/zh/docs/graphql/queries/advanced/filter-documents/)
- [分页](/zh/docs/graphql/queries/advanced/pagination/)
- 参照完整性
...
你也可以选择[自托管数据层](/zh/docs/self-hosted/overview)作为替代方案。
...
- [tina路径](/zh/docs/tinacloud/dashboard/projects/#path-to-tina)更改
- 配置的[存储库](/zh/docs/tinacloud/dashboard/projects/#changing-the-repository)更改
- 在GitHub中创建了新分支
...
使用[刷新Webhooks](/zh/docs/tinacloud/dashboard/projects/#refresh-webhooks)按钮重新初始化webhook。
...
请参阅[故障排除指南](/zh/docs/tinacloud/troubleshooting#3-how-do-i-resolve-errors-caused-by-unindexed-branches)以获取简短的操作步骤。

### 导出分支

在分支上使用“重新索引”将丢弃TinaCloud中尚未推送到存储库的任何更改。如果你需要从TinaCloud导出未保存的内容，可以使用[导出分支](/zh/docs/tinacloud/dashboard/projects/#export-branch)按钮将存储库的当前状态导出到新分支。
...
要了解更多关于自托管的信息，请参阅[自托管概述](/zh/docs/self-hosted/overview)。