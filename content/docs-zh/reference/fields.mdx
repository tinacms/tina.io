...
字段定义了内容结构，以及在编辑器中为特定[集合](/zh/docs/reference/collections)显示的表单字段。
...
* [`rich-text`](/zh/docs/reference/types/rich-text/)(markdown)
...
<apiReference
  ...
  property={[
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "这可以用于存储值的数组。[检查兼容性](/zh/docs/reference/fields#list-fields)。\n"
    },
    {
      groupName: "ui",
      name: "min",
    ...
    },
    {
      ...
      description:
        "用于自定义字段验证。[检查兼容性](/zh/docs/reference/fields#validating-field-values)。\n"
    },
    {
      groupName: "ui",
      name: "parse",
    ...
    },
    {
      ...
      description:
        "用于[自定义字段组件](/zh/docs/extending-tina/custom-field-components)。\n"
    }
  ]}
/>
...
* [引用字段类型](/zh/docs/reference/types/reference/)不能设置为列表。要解决此问题，可以将它们[包装](/zh/docs/reference/types/object/#using-list-object-as-a-wrapper-for-other-types)在标记为 `list: true` 的对象字段类型中。
* 只有以下类型在CMS中内置了专用的列表UI...
  * [字符串字段类型](/zh/docs/reference/types/string)
  * [对象字段类型](/zh/docs/reference/types/object/)
  * [图像字段类型](/zh/docs/reference/types/image/)
...
在[对象字段类型](/zh/docs/reference/types/object/)的列表上设置 `ui.max` 后，一旦添加了至少给定数量的元素，编辑器中的添加按钮将被禁用。
