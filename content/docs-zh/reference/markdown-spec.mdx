...
虽然大多数 markdown 功能都可以直接使用，但 TinaCMS 会忽略它无法处理的元素。我们*不*期望支持完整的 [CommonMark](https://commonmark.org/) 和 [GitHub Flavored Markdown](https://github.github.com/gfm/) 规范。请务必通过我们的[社区渠道](/community/)表达您对各种富文本功能的支持！
