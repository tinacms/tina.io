...
> 提示：一个常见错误是运行 `gatsby clean` **在** `tinacms build` 之后。这会导致您的管理 html 文件被清除。有关更多常见错误，请参阅[常见错误](/zh/docs/forestry/common-errors)页面。
...
* [Astro 设置指南](/zh/docs/frameworks/astro/) - 使用 Tina 与 Astro（我们的默认入门）
* [Next.js 设置指南](/zh/docs/frameworks/next/app-router/) - 使用 Tina 与 Next.js
