...
last_edited: '2025-10-21T09:35:02.227Z'
...
> 注意：`--port 8080` 可以在 `astro dev` 后添加以指定自定义端口。
...
> **注意：** 使用 Astro 的可视化编辑目前是实验性的。[查看讨论](https://github.com/tinacms/tinacms/discussions/3399)。
