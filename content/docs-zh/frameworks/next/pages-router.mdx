...
这将询问您一些设置问题。当提示输入 **public assets directory** 时，输入：**public**。
...
此时，您应该能够看到Tina管理页面，选择一个帖子，保存更改，并看到更改已持久化到本地的markdown文件中。

![TinaCMS管理截图](/img/hugo-tina-admin-screenshot.png)
