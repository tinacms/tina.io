...
如果你想自托管TinaCMS后端，并且不想使用我们的[预配置入门](/docs/self-hosted/starters/nextjs-vercel/)，你可以按照以下步骤进行。
...
如果你已经在项目中设置了TinaCMS，请确保所有tina包都是最新版本。
...
初始化命令完成后，**确保复制**在终端中打印的环境变量。你还需要将这些添加到你的托管提供者中。
