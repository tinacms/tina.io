...
可以在[GitHub账户设置](https://github.com/settings/personal-access-tokens/new)中创建一个GitHub个人访问令牌。
...
* 如果你想更改你的Git提供者、数据库适配器或身份验证提供者，请查看[参考](/docs/reference/self-hosted/overview/)。
