...
- 用于其[身份验证提供者](/docs/reference/self-hosted/auth-provider/overview)的 [NextAuth](/docs/reference/self-hosted/auth-provider/authjs)
...
查看 [用户管理文档](/docs/self-hosted/user-management/)以获取有关如何添加其他用户的信息。
