...
* **将其作为独立的无服务器函数部署**在您的站点旁边：[Vercel Functions](/docs/reference/self-hosted/tina-backend/vercel-functions/)或[Netlify Functions](/docs/reference/self-hosted/tina-backend/netlify-functions/)。[tina-self-hosted-static-demo](https://github.com/tinacms/tina-self-hosted-static-demo)是一个静态站点的工作示例，后端作为其自身的函数。
