...
TinaCMS 主要通过 GitHub 和静态托管平台集成实现自动内容库更新，但**像 Vercel、Netlify 和 GitHub Pages 这样的静态托管平台在中国大陆无法访问**，且没有直接的中国替代方案。
...
鉴于这些限制，本指南将引导您将 TinaCMS 项目部署到 **阿里云**。作为中国领先的云服务提供商，阿里云为中国用户提供可靠的性能。虽然目前没有中国云服务能够像 Vercel 那样无缝集成 GitHub，但阿里云仍然是希望在中国大陆部署网站的开发者的首选。

## 阿里云配置

阿里云提供多种服务器选项。我们通常建议使用 **弹性计算服务 (ECS)** 来部署 TinaCMS 项目。有关创建和配置服务器的详细说明，请参阅[阿里云官方文档](https://www.alibabacloud.com/help/en/elastic-compute-service)。
