...
鉴于这些限制，本指南将引导您将 TinaCMS 项目部署到 **阿里云**。作为中国领先的云服务提供商，阿里云为中国用户提供可靠的性能。虽然目前没有中国云服务提供商能像 Vercel 那样无缝集成 GitHub，但阿里云仍然是希望在中国大陆部署网站的开发者的首选。

## 阿里云配置

阿里云提供多种服务器选项。我们通常推荐使用 **弹性计算服务 (ECS)** 来部署 TinaCMS 项目。有关创建和配置服务器的详细说明，请参阅[阿里云官方文档](https://www.alibabacloud.com/help/en/elastic-compute-service)。
