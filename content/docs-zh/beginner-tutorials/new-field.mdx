...
> `isBody` 属性正如其名 - 它告诉 TinaCMS 这个属性是markdown内容的“正文”（即，*不*在前置元数据中）。

### 显示我们的新内容

1. 编辑 `app/awesome-content.tsx` 组件，使其渲染出正文内容：
...
2. 启动你的应用，导航到 `http://localhost:3000`，你将看到屏幕上显示了你不可思议的正文。

> 那编辑呢？好吧，试着访问 `http://localhost:3000/admin/index.html`，你会看到一个新字段神奇地出现在你的可视化编辑器中。太棒了！🙌 🎉
