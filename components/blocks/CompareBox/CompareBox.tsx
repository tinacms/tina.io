    ...
    >
      ...
      <span
        className={`font-ibm-plex  ${
          company.active
            ? 'bg-linear-to-br text-black bg-clip-text'
            : 'text-gray-500'
        }`}
      >
  ...
  return (
    <div className="md:px-10 lg:px-10 rounded-lg w-full">
      <div className="px-8 py-8 md:px-8 bg-linear-to-br from-white/25 via-white/50 to-white/75  break-inside-avoid rounded-xl shadow-2xl">
        <h1 className={`${BLOCK_HEADINGS} pl-3 font-ibm-plex flex items-center text-center justify-center text-4xl lg:text-5xl lg:leading-tight bg-linear-to-br from-blue-600/80 via-blue-800/80 to-blue-1000 bg-clip-text text-transparent text-balance px-2 mt-10 pb-8`}>
          Why Tina?
        </h1>
        <div
