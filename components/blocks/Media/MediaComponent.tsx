...
const MediaComponent = ({ data }) => {
  ...
  return (
    <div className="media-component md:px-8 xl:px-8 lg:px-8 px-3 max-w-(--breakpoint-xl) mx-auto pb-4 pt-8">
      <h2 className={`${BLOCK_HEADINGS} font-ibm-plex text-center sm:pt-10 md:pt-4 lg:pt-0 lg:leading-tight bg-linear-to-br from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent pb-10`}>
        {headline}
      </h2>
