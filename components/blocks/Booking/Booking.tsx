    ...
    <div className="flex justify-center w-full">
      <div className="lg:w-1/2 container mx-auto px-4">
        ...
        <div className="grid gap-3 my-16 px-10 py-12 md:bg-linear-to-br from-white/25 via-white/50 to-white/75 break-inside-avoid md:shadow-md rounded-lg">
          <h1 className={`${BLOCK_HEADINGS} w-full text-center inline-block m-0 font-ibm-plex whitespace-nowrap lg:leading-tight bg-linear-to-br from-orange-400 via-orange-500 to-orange-600 bg-clip-text text-transparent`}>
            {data.title}
          </h1>
