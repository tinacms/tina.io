...
const TextAndMediaColumnsComponent = ({ data }) => {
  ...
  return (
    <div className="px-3 max-w-(--breakpoint-xl) mx-auto w-full">
      <div className="lg:grid lg:grid-cols-7 mx-auto md:pb-16">
        <div
          className={`mx-6 my-auto lg:col-span-4 row-start-1 md:h-auto ${
            isVideoOnLeft ? 'lg:mr-0 lg:col-start-1' : 'lg:col-start-4 lg:ml-0'
          }`}
        >
          {VideoGridComponent({
            data: { mediaItem: mediaColumnItem, typenames },
          })}
        </div>
        <div
