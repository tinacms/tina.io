//Due to design implementations and how users interact with the rich-text field, this component is
//designed to enforce h1-h5 to be the same size and for h6 to be smaller.

export const whatsNewMDComponents = {
