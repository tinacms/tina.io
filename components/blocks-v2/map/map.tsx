...
const OFFICES: Office[] = [
  ...
  },
  {
    ...
    streetAddress: "Room 305, Building 2, Xingcheng Development Building, No. 406 Xintiandi Street",
    ...
    <div className="flex flex-col gap-8 items-center justify-center p-10 max-w-7xl mx-auto relative">
      ...
      <div className="flex gap-8 w-full">
              ...
              >
                <div className="text-sm pl-2 pt-2">
                  ...
                  <div className="space-y-1 text-gray-700">
                    ...
                    <div>{office.addressLocality}, {office.addressRegion}</div>
                    <div>{office.addressCountry} {office.postalCode}</div>
                    <div className="mt-2">
                      <a href={`tel:${office.phone}`} className="text-[#ea6d43] hover:underline">
                        {office.phone}
                      </a>
                    </div>
        ...
        <div className="flex-1">
          <svg viewBox="0 0 895.92 471.76" preserveAspectRatio="xMinYMin" className="relative w-full">
        <defs>
        ...
        {Object.entries(allCountries).map(([countryKey, pathData]) => {
          const isSelected = selectedCountriesSet.has(countryKey as Country);
