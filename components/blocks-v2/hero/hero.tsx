...
export default function HeroV2(data: { data: PageBlocksHeroV2 }) {
  const { title, subtext, buttons, image, buttonHorizontalAlignment } = data.data || {};
    ...
    >
      <div className="flex items-center flex-col gap-8  border-red-500 py-10">
        ...
        {buttons && buttons.length > 0 && (
          <div className={`flex ${alignment == 'left' ? 'justify-start' : 'justify-center md:justify-start'} w-full flex-row flex-wrap gap-2 max-w-[62ch]`}>
