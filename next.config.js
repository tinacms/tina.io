...
const config = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/docs/fields/',
        destination: '/docs/reference/toolkit/fields/',
        permanent: true,
      },
      {
        source: '/docs/fields/text/',
        destination: '/docs/reference/toolkit/fields/text/',
        permanent: true,
      },
      {
        source: '/docs/fields/textarea/',
        destination: '/docs/reference/toolkit/fields/textarea/',
        permanent: true,
      },
      {
        source: '/docs/fields/number/',
        destination: '/docs/reference/toolkit/fields/number/',
        permanent: true,
      },
      {
        source: '/docs/fields/image/',
        destination: '/docs/reference/toolkit/fields/image/',
        permanent: true,
      },
      {
        source: '/docs/fields/color/',
        destination: '/docs/reference/toolkit/fields/color/',
        permanent: true,
      },
      {
        source: '/docs/fields/toggle/',
        destination: '/docs/reference/toolkit/fields/toggle/',
        permanent: true,
      },
      {
        source: '/docs/fields/radio-group/',
        destination: '/docs/reference/toolkit/fields/radio-group/',
        permanent: true,
      },
      {
        source: '/docs/fields/select/',
        destination: '/docs/reference/toolkit/fields/select/',
        permanent: true,
      },
      {
        source: '/docs/fields/tags/',
        destination: '/docs/reference/toolkit/fields/tags/',
        permanent: true,
      },
      {
        source: '/docs/fields/list/',
        destination: '/docs/reference/toolkit/fields/list/',
        permanent: true,
      },
      {
        source: '/docs/fields/group/',
        destination: '/docs/reference/toolkit/fields/group/',
        permanent: true,
      },
      {
        source: '/docs/fields/group-list/',
        destination: '/docs/reference/toolkit/fields/group-list/',
        permanent: true,
      },
      {
        source: '/docs/fields/blocks/',
        destination: '/docs/reference/toolkit/fields/blocks/',
        permanent: true,
      },
      {
        source: '/docs/fields/date/',
        destination: '/docs/reference/toolkit/fields/date/',
        permanent: true,
      },
      {
        source: '/docs/fields/markdown/',
        destination: '/docs/reference/toolkit/fields/markdown/',
        permanent: true,
      },
      {
        source: '/docs/fields/html/',
        destination: '/docs/reference/toolkit/fields/html/',
        permanent: true,
      },
      {
      ...
      {
        source: '/guides/tinacms/non-react-based-ssg/guide/',
        destination: '/docs/frameworks/other/',
        permanent: true,
      },
      {
        source: '/docs/editing/active-field-indicator/',
        destination:
          '/docs/contextual-editing/react/#click-to-edit-experimental',
        permanent: true,
      },
      {
        source: '/guides/tinacms/nextjs-internationalization/guide/',
